<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PledgeValid.aspx.cs" Inherits="DonateMgr_PledgeValid" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        function MailPrint() {
            window.open('../DonateMgr/PledgeValid_MailPrint.aspx', 'PledgeValid_MailPrint', 'toolbar=no,location=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,top=0,left=0,width=850,height=600', '');
        }
        function Address() {
            window.open('PledgeValid_Print/PledgeValid_Print_Style' + $("#ddlFormat").val() + '.aspx', 'PledgeValid_Print_Style' + $("#ddlFormat").val(), 'toolbar=no,location=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,top=0,left=0,width=800,height=600', '');
        }
        function Preview() {
            window.open('../DonateMgr/PledgeValid_Preview.aspx', 'PledgeValid_Preview', 'toolbar=no,location=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,top=0,left=0,width=850,height=600', '');
        }
    </script>
</head>
<body class="body">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:dropdownlist runat="server" ID="ddlMonth_Donate_Valid" CssClass="font9"></asp:dropdownlist>
                月
                <asp:dropdownlist runat="server" ID="ddlYear_Donate_Valid" CssClass="font9"></asp:dropdownlist>
                年
            </td>
        </tr>
        <tr>
