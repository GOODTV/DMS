...
public partial class DonateMgr_DonateInfo_Print_Excel : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            AjaxShowMessage("請先查詢後再做匯出！");
            this.ClientScript.RegisterStartupScript(this.GetType(), "js", @"<script language='javascript' >history.go(-1);</script>");
        }
    }
    //---------------------------------------------------------------------------
    private void Print_Excel(string strSql)
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "Donate");
    }
    //---------------------------------------------------------------------------
