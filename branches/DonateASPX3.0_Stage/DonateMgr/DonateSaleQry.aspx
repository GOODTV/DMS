<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonateSaleQry.aspx.cs" Inherits="DonateMgr_DonateSaleQry" %>
...
<body class="body">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        <tr>
            ...
            <td lign="left" colspan="1" >
                <asp:TextBox runat="server" ID="tbxSale_Subject" CssClass="font9" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right"  colspan="4">
                <asp:Button ID="btnQuery" CssClass="npoButton npoButton_Search" runat="server"  Width="20mm"
                 ...
                 <asp:Button ID="btnHistoryQuery" CssClass="npoButton npoButton_Search" 
                    runat="server"  Width="30mm"
                    Text="歷史資料查詢" onclick="btnHistoryQuery_Click" visible="false"/>
