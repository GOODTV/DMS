<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pledge_Merge.aspx.cs" Inherits="DonateMgr_Pledge_Merge" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        function Transfer_OnClick() {
            if (window.confirm('您是否確定要合併轉帳授權書資料？') == true) {
                return true
            }
            else {
                return false;
