...
public partial class DonateMgr_DonateInfoQry : BasePage
{
    ...
    public void AuthrityControl()
    {
        ...
        Authrity.CheckButtonRight("_AddNew", btnDonor_Add);
    ...
    public void LoadFormData()
    {
        ...
        strSql += " CONVERT(VARCHAR(10) , Last_DonateDate, 111 ) as [最近捐款日期], Donor_Id_Old as [舊編號]\n";
        ...
        {
            strSql += " and Donor_Id_Old like '%" + tbxDonor_Id_Old.Text.Trim() + "%' ";
        }
        ...
        {
            //20140428 Modify by GoodTV Tanya:查詢結果開啟分頁
            //Grid initial
            ...
            npoGridView.EditLink = Util.RedirectByTime("Donate_Add.aspx", "Donor_Id=");
    ...
    {
        //if (tbxDonor_Name.Text.Trim() == "" && tbxDonor_Id.Text.Trim() == "" && tbxDonor_Id_Old.Text.Trim() == "" && ddlDonor_Type.SelectedIndex == 0 && tbxIDNo.Text.Trim() == "" && tbxCellular_Phone.Text.Trim() == "" && ddlCity.SelectedIndex == 0 && ddlCity.SelectedIndex == 0 && tbxAddress.Text.Trim() == "")
        //{
        //    lblGridList.Text = " **請輸入查詢條件！ ** ";
        //    ShowSysMsg("請輸入查詢條件");
        //    return;
        //}
        LoadFormData();
