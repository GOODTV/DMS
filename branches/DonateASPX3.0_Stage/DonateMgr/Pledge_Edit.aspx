<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pledge_Edit.aspx.cs" Inherits="DonateMgr_Pledge_Edit" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        function initCalendar() {
            ...
            Calendar.setup({
                inputField: "tbxBreak_Date",   // id of the input field
                button: "imgBreak_Date"     // 與觸發動作的物件ID相同
            });
        }
        ...
        function CheckFieldMustFillBasic() {
            ...
            // 2014/4/10 增加下次扣款日的驗證
            if (tbxNext_DonateDate.value == "") {
                strRet += "下次扣款日 ";
            }
            if (ddlDept.value == "") {
                strRet += "機構名稱 ";
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        <tr>
            ...
            <td align="left" colspan="1" >
                <asp:TextBox runat="server" ID="tbxPledge_Id" CssClass="font9" 
        ...
        <tr>
            ...
            <td align="left" colspan="3">
                ...
                ~
                <asp:TextBox ID="tbxDonate_ToDate" runat="server" onchange="CheckDateFormat(this, '授權期間');"></asp:TextBox>
            ...
            <td align="left" colspan="1">
                <asp:TextBox ID="tbxNext_DonateDate" runat="server" onchange="CheckDateFormat(this, '下次扣款日');"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:TextBox runat="server" ID="tbxBreak_Date" onchange="CheckDateFormat(this, '停止日期');" CssClass="font9"></asp:TextBox>
                <img id="imgBreak_Date" alt="" src="../images/date.gif" />
            </td> 
            <th align="right" colspan="1">
                停止原因：
            </th>
            <td align="left" colspan="3">
                <asp:TextBox runat="server" ID="tbxBreak_Reason" CssClass="font9"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th align="right" colspan="1">
