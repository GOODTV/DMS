...
public partial class Online_CheckOut : System.Web.UI.Page
{
   ...
   //暫存**********************************
    ...
    private void LoadData(string strDonorID)
    {
        ...
        strSql = @"select * from DONOR  where Donor_Id=@DonorID and DeleteDate is null ";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            Util.SetDdlIndex(ddlOverseasCountry, dr["OverseasCountry"].ToString());
            //地址
    ...
    protected void btnCheckOut_Click(object sender, EventArgs e)
    {
        ...
        //20151030拿掉 對GOODTV說的話，改在奉獻問卷裡
        //2015/3/4增加想對GOODTV說的話的table(DonorToSayGoodTV)
        //儲存捐款人想對GOODTV說的話
        //if (!String.IsNullOrEmpty(txtToGoodTV.Text))
        //{
        //    dict = new Dictionary<string, object>();
        //    list = new List<ColumnData>();
        //    //捐款人編號
        //    list.Add(new ColumnData("Donor_Id", HFD_DonorID.Value, true, false, false));
        //    list.Add(new ColumnData("ToGoodTV", txtToGoodTV.Text, true, false, false));
        //    list.Add(new ColumnData("Create_DateTime", Util.GetToday(DateType.yyyyMMddHHmmss), true, false, false));
        ...
        //    string strSqlCommand = Util.CreateInsertCommand("DonorToSayGoodTV", list, dict);
        //    NpoDB.ExecuteSQLS(strSqlCommand, dict);
        //}

        ClientScript.RegisterStartupScript(this.GetType(), "s", "<script>document.forms[0].action='DonateInfoConfirm.aspx'; document.forms[0].submit();</script>");
    ...
    private void SetColumnData(List<ColumnData> list)
    {
        ...
        //20151030拿掉 對GOODTV說的話，改在奉獻問卷裡，不需發信了
