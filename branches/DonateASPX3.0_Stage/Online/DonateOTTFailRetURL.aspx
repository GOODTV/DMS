<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonateOTTFailRetURL.aspx.cs" Inherits="Online_DonateOTTFailRetURL"  validateRequest="false" %>
        ...
        <tr>
            <td colspan="2" align="center">
                <%-- <asp:Button ID="btnConfirm" class="css_btn_class" runat="server" Text="回到奉獻首頁"
                    OnClientClick="document.location.href='DonateOnlineAll.aspx';" />--%>
            </td>
        </tr>
    </table>
    </form>
