<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import_Donate.aspx.cs" Inherits="Import_Import_Donate" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                <asp:Button ID="btnInput" runat="server"  Width="30mm"
                    Text="匯入捐款資料"  CssClass="npoButton npoButton_Export"
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                4.相關欄位說明請下載&nbsp;<a href='example/捐款匯入參考範例.xls'>參考範例</a>&nbsp;。
            </td> 
        </tr>
    </table>
    </div>
