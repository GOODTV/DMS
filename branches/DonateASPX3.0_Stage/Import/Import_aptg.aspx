<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import_aptg.aspx.cs" Inherits="Import_Import_aptg" %>
...
<body class="body">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:RadioButton ID="rbDonate_Date_File" runat="server" Text="依檔案內的『 立帳年月 』" 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                <asp:Button ID="btnInput" runat="server"  Width="45mm"
                    Text="匯入『亞太捐款』資料"  CssClass="npoButton npoButton_Export"
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                4.相關欄位說明請下載&nbsp;<a href='example/亞太參考範例.xls'>參考範例</a>&nbsp;。
            </td> 
        </tr>
    </table>
    </div>
