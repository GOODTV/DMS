...
public partial class Ecbank_EcbankCardQry_Print_Excel : BasePage
{
    ...
    private void Print_Excel(string strSql)
    {
        ...
        GridList.Text = GetTitle() + GetTime() + GetTable1(strSql);
        Util.OutputTxt(GridList.Text, "1", "ecbank_card");
    }
    //---------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------
    private string GetTable1(string strSql)
    {
        //組 table
        HtmlTable table = new HtmlTable();
        HtmlTableRow row;
        ...
        DataTable dtRet = CaseUtil.EcBankCardQry_Print(dt);
