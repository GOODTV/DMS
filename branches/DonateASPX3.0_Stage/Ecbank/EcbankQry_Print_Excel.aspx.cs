...
public partial class Ecbank_EcbankQry_Print_Excel : BasePage
{
    ...
    private void Print_Excel(string strSql)
    {
        ...
        Util.OutputTxt(GridList.Text, "1", "ecbank");
    }
    //---------------------------------------------------------------------------
    ...
    private string GetTable1(string strSql)
    {
        ...
        DataTable dtRet = CaseUtil.EcBankQry_Print(dt);
