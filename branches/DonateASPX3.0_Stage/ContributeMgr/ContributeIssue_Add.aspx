<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContributeIssue_Add.aspx.cs" Inherits="ContributeMgr_ContributeIssue_Add" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbxIssue_Processor.value = '加百列';
            tbxIssue_Date.value = myStartDate.getFullYear() + '/' + GetFormatDate((myStartDate.getMonth() + 1)) + '/' + GetFormatDate(myStartDate.getDate());
        });
    </script>
    <script type="text/javascript">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="center" colspan="1">
                <asp:checkbox runat="server" ID="cbxIssue_Pre" Text="手開領用編號" CssClass="font9" OnClick="cbxIssue_Pre_OnClick()" ></asp:checkbox>
            </td>
            <th align="right" colspan="1">
                領用編號：
            </th>
            <td align="left" colspan="1">
                <asp:TextBox runat="server" ID="tbxIssue_No" CssClass="font9" Text="自動編號"
                   ></asp:TextBox>
            </td>
        </tr>
         <tr>
