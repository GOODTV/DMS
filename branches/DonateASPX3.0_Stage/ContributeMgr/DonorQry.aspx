<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonorQry.aspx.cs" Inherits="ContributeMgr_DonorQry" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            <td align="right"  colspan="8">
                ...
                <asp:Button ID="btnDonor_Add" CssClass="npoButton npoButton_New" runat="server"  Width="35mm"
                    Text="新增捐贈人資料" OnClick="btnDonor_Add_Click" align="right"/>
            </td>
        </tr>
        <tr>
