...
public partial class Report_Custom_Report_Donate_Other_Report3_Print : BasePage
{
    ...
    private void PrintReport()
    {
        ...
        GridList.Text = "雷同聯絡資料明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>查詢日期：" + DateTime.Now.ToString() + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人姓名或地址排序</span><br>" + htw.InnerWriter.ToString();
