...
public partial class Report_Custom_Report_Donate_Other_Report2_Print : BasePage
{
    ...
    private void PrintReport()
    {
        ...
        GridList.Text = "DVD贈品索取人報表<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>贈送日期：" + HFD_ContributeDateS_other2.Value + "~" + HFD_ContributeDateE_other2.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人編號排序</span><br>" + htw.InnerWriter.ToString();
