...
public partial class Report_Custom_Report_Donate_Other_Report6_Print_Excel : BasePage
{
    ...
    private void Print_Excel(string strSql, String Report_condition)
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "donor_statistics");
    }
    private string Sql()
    {
        string strSql;
    ...
    private string GetTitle(DataRow dr, String Report_condition)
    {
        ...
        string strTitle = "<span style='font-family: 標楷體'>捐款人" + Condition_Chs + "分析</span><br>" + "<span style='font-size: 9pt; font-family: 新細明體'>統計項目：" + Condition_Chs + "<br>";
