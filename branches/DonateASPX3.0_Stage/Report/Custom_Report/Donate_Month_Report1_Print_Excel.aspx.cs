...
public partial class Report_Custom_Report_Donate_Month_Report1_Print_Excel : BasePage
{
    ...
    private void Print_Excel()
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "donate_month_report1");
    }
    //---------------------------------------------------------------------------
    private string GetTitle(DataRow dr)
    {
        ...
        string strTitle = "捐款人生日明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計日期：" + DateTime.Now.ToString() + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人生日日期排序</span>";
