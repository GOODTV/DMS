<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Add.aspx.cs" Inherits="MemberMgr_Member_Add" %>
    ...
    <script type="text/javascript">
        ...
        function WindowsOpen(i) {
            window.open('MemberShow.aspx?Donor_Id=HFD_Donor_Id' + '&Donor_Name=tbxIntroducer_Name', 'NewWindows',
                        'status=no,scrollbars=yes,top=100,left=120,width=800,height=600);');
        }
        function CheckFieldMustFillBasic() {
            ...
            if (isNaN(Number(tbxFax_Loc.value)) == true || isNaN(Number(tbxFax.value)) == true) {
                alert('傳真 欄位必須為數字！');
                tbxFax.focus();
                return false;
            }
            ...
            <th align="right" colspan="1">通訊地址：
             ...
             <td align="left" colspan="7" >
                <asp:CheckBox ID="cbxIsLocal" runat="server" text="台灣本島" 
                     AutoPostBack="True" oncheckedchanged="cbxIsLocal_CheckedChanged" Checked="true"></asp:CheckBox>
                ...
                Attn：<asp:TextBox runat="server" ID="tbxAttn" CssClass="font9" Width="200px"></asp:TextBox>
                <br />
