...
<body class="body" onload="MM_preloadImages('images/index_login_bt_hover.gif');MM_showHideLayers('contact','','hide','copy','','hide')">
    ...
    <div id="container">
        <div id="logo">
            <img src="images/logo RGB.png" width="239" height="60" align="absmiddle" style="padding-top: 39px;" /></div>
        <div id="login">
            <table border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <th width="50" align="center" class="auto-style1">
                        機 構
                    </th>
                    <td width="200" valign="middle" class="auto-style1">
                        <label>
                ...
                <tr>
                    ...
                    <td width="200" valign="middle">
                        <label>
                            <asp:TextBox ID="txtUserID" runat="server" Width="100" Text=""></asp:TextBox>
                        </label>
                    </td>
                </tr>
                <tr>
        ...
        <div id="sysname"><br/><br/>　　　　　　　 　　　　　　　　　　　　　　　　　<font size="3">3.0 測試機</font>
        </div>
    </div>
    </form>
</body>
