<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Email_Add.aspx.cs" Inherits="EmailMgr_Email_Add" ValidateRequest="false"%>
        ...
        <tr>
	      ...
	      <td width="80%" class="font11" valign="top" rowspan = "2">
            <div align="center"><center>
              ...
              <div class="function">
                  <asp:Button ID="btnAdd" class="npoButton npoButton_Modify" runat="server" 
                      Text="儲存" OnClientClick= "return CheckFieldMustFillBasic();" onclick="btnAdd_Click"/>
