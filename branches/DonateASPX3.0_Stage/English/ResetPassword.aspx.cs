...
public partial class Online_ResetPassword : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            string stremailHead = "Dear " + txtDonorName.Text + " <BR><BR>";
            string strReport = "Please click on the following link to reset your password.<BR>";
            ...
            //strReport += "http://donate3.goodtv.tv/Online/SetPassword.aspx?DonorId=" + Util.desEncryptBase64(strDonorId);
            strReport += "<BR><BR><BR>";
            strReport += "Any questions please call us at: 02-8024-3911 <BR>";
            ...
            string strEmailSubject = "GOODTV - Reset Password";
            ...
            try
            {
                ...
                Page.ClientScript.RegisterStartupScript(this.GetType(), "PopupScript", "<script type='text/javascript'>alert('An instruction is sent.');</script>");
            }
            catch (Exception ex)
            {
