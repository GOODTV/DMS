<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonateOnlineUsual.aspx.cs"
    Inherits="Online_DonateOnlineUsual" %>
        ...
        <tr>
            ...
            <td width="200" align="left" valign="top" bgcolor="#FFFFFF">
                <table width="200%" border="0" cellspacing="1" cellpadding="1">
                    <tr>
                        <td>
                            <a href="donate_index.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','images/btn_首頁_don.jpg',1)">
                                <img alt="首頁" src="images/btn_首頁_on.jpg" name="Image6" width="120" height="26" border="0"
                                    id="Image6" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <img src="images/btn_經常奉獻_don.jpg" width="120" height="36" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <a href="DonateOnlineOther.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('btn_4','','images/btn_其他_don.jpg',1)">
                                <img alt="其他奉獻頁面" src="images/btn_其他_on.jpg" name="btn_4" width="120" height="35" border="0" id="btn_4" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td width="700" align="left" valign="top" bgcolor="#FFFFFF">
                <table width="700" border="0" align="left" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="2" align="center" style="text-align:center" valign="middle" bgcolor="#5F8FB3">
                            <font color="#FFFFFF" size="+1">經　常　奉　獻</font>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">
                            <font size="+1" color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我們需要你 We Want You</font>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" valign="middle">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;「他又對他們說，你們往普天下去，傳福音給萬民聽。」（馬十六15）耶穌交因為看見這世代家庭的需要，我們起來回應神的呼召，GOOD
                            TV是空軍，我們一直在做的就是撒網的工作，盡可能透過無遠弗屆的電波和網路，將福音的好消息發送出去。
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" valign="middle">
...
<%--                    <tr>
                    ...
                    <tr>
                        <td height="176" colspan="2" align="center">
                            <img src="images/pic_經常奉獻.jpg" width="700" height="100" />
                        </td>
                    </tr>
                </table>
            </td>
