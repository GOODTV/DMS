...
<head id="Head1" runat="server">
    ...
    <title>Your Donation Items</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ItemPeriod td:nth-child(2)').css('text-align', 'right');
            $('#ItemPeriod td:nth-child(3)').css('text-align', 'center');
            ...
            $('#ItemOnce td:nth-child(4)').css('text-align', 'center');
                ...
                <table width="95%" border="0" align="center" cellpadding="5" cellspacing="5">
                    <tr>
                        <td align="left" valign="bottom">
                            <strong><font color="#003399">Your Donation Items</font></strong>
                        </td>
                        <td align="right" valign="bottom">
                            <strong><font color="#003399">Language：</font><a href="../Online/ShoppingCart.aspx" target="_self"><font size="3">中文</font></a></strong>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr valign="top">
            <td height="405" colspan="3" style="background-image:url('images/bk_fish.jpg')" align="center">
                ...
                <table width="80%">
                    <tr>
                        <td>
                            <asp:Label ID="lblStep1" runat="server" Text=" Your Donation Items >> " ForeColor="Red" />
                ...
                <br><span align='center' style='color: #444444; font-size: 10;'>
                        1.Recurring plan: your donation may recur on the monthly, quarterly and yearly basis of your choice.<br><br><!--We accept <font color="red">VISA、MASTER、JCB</font> only.<br><br>-->
                        2.If you would like to cancel your recurring plan, please call (02)8024-3911 .Thank you for your support.
                    </span>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        ...
                        <td width="100">
							<asp:Button ID="btnContinue" runat="server" class="Online Online_Button3" Text="Previous"
                                OnClick="btnContinue_Click" Width="90px" />
                        ...
                        <td width="180">
                            <asp:Button ID="btnCheckOut" runat="server" class="Online Online_Button5" Text="Next"
                                OnClick="btnCheckOut_Click" Width="174px" />
