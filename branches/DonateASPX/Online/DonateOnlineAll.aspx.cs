...
public partial class Online_DonateOnlineAll : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            list.Add(new ControlData("Radio", "Item", "RDO_Item1", "單筆奉獻", "單筆奉獻", false, ""));
            ...
            list.Add(new ControlData("Radio", "Item", "RDO_Item2", "定期定額奉獻", "定期定額奉獻", false, ""));
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        Session["AddShopping"] = "AddShopping"; 
