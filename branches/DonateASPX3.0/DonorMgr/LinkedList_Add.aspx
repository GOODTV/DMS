<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkedList_Add.aspx.cs" Inherits="DonorMgr_Linked_List_Add" %>
                                ...
                                <center>
                                    ...
                                    <div class="function">
                                        <asp:Button ID="btnSave" runat="server" Text="存檔" OnClick="btnSave_Click" 
                                             CssClass="npoButton npoButton_Save" OnClientClick= "return CheckFieldMustFillBasic(); "/>
