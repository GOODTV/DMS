<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonorStatQry.aspx.cs" Inherits="DonorMgr_Donor_Stat_Qry" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        function Print(PrintType) {
            var cbxIs_Abroad = document.getElementById('cbxIs_Abroad');
            var cbxIs_ErrAddress = document.getElementById('cbxIs_ErrAddress');
            var cbxSex = document.getElementById('cbxSex');
            $.ajax({
                type: 'post',
                url: "../common/ajax.aspx",
                data: 'Type=5' + '&Category=' + $("input[id^='<% =rblCategory.ClientID %>']:checked").val(),
                async: false, //同步
                success: function (result) {
                },
                error: function () { alert('ajax failed'); }
            })
            window.open('../DonorMgr/DonorStatQry_Print.aspx?Is_Abroad=' + cbxIs_Abroad.checked + '&Is_ErrAddress=' + cbxIs_ErrAddress.checked + '&Sex=' + cbxSex.checked + '&"', 'DonorStatQry_Print', 'width=900,height=650,scrollbars=yes,menubar=yes,location =no,status=no,toolbar=no', '');
        }
        ...
        <tr>
            ...
            <td align="left">
                <asp:RadioButtonList ID="rblCategory" runat="server" 
                    ...
                    <asp:ListItem Value="9">收據縣市</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
            ...
            <td align="left" colspan="5">
                <asp:CheckBox ID="cbxIs_Abroad" runat="server" Checked="True" Text="海外地址" />
                <asp:CheckBox ID="cbxIs_ErrAddress" runat="server" Checked="True" Text="錯址" />
                <asp:CheckBox ID="cbxSex" runat="server" Checked="True" Text="歿" />
            </td> 
           </tr>
        <tr>
