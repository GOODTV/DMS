...
public partial class DonorMgr_AddressList_Post : BasePage
{
    ...
    public void Print(string strSql)
    {
        ...
        if (dt_Donor.Rows.Count != 0)
        {
            ...
            GridList.Text += "    <td width='5%' height='25' rowspan='2'><div align='center' class='style3'>重量</div></td>";
            GridList.Text += "    <td width='5%' height='25' rowspan='2'><div align='center' class='style3'>郵資</div></td>";
            GridList.Text += "    <td width='5%' height='25' rowspan='2'><div align='center' class='style3'>備考</div></td>";
            GridList.Text += "  </tr>";
            GridList.Text += "  <tr>";
            GridList.Text += "    <td width='10%' height='25'><div align='center' class='style3'>姓名</div></td>";
            GridList.Text += "    <td width='41%' height='25'><p align='center' class='style3'>寄達第名(或地址)</p>    </td>";
            GridList.Text += "  </tr>";
            ...
            while (end == false)
            {
                ...
                GridList.Text += "<tr>";
                GridList.Text += "  <td width='5%' height='28'><div align='center' class='style3'>" + Row + "</div></td>";
                GridList.Text += "  <td width='10%' height='28'><span class='style3'></span></td>";
                GridList.Text += "  <td width='10%' height='28'><span class='style3'>" + dr_Donor["捐款人"].ToString() + "</span></td>";
                GridList.Text += "  <td width='41%' height='28'><span class='style3'>" + dr_Donor["郵遞區號"].ToString() + dr_Donor["地址"].ToString() + "</span></td>";
                GridList.Text += "  <td width='6%' height='28'><span class='style3'></span></td>";
                GridList.Text += "  <td width='6%' height='28'><span class='style3'></span></td>";
                GridList.Text += "  <td width='6%' height='28'><span class='style3'></span></td>";
                GridList.Text += "  <td width='5%' height='28'><span class='style3'></span></td>";
                GridList.Text += "  <td width='5%' height='28'><span class='style3'></span></td>";
                GridList.Text += "  <td width='5%' height='28'><span class='style3'></span></td>";
                GridList.Text += "</tr>";
            ...
            if ((Row + 20) % 20 != 0)
            {
                ...
                {
                    GridList.Text += "<tr>";
                    GridList.Text += "  <td width='5%' height='28'><div align='center' class='style3'> </div></td>";
                    GridList.Text += "  <td width='10%' height='28'><span class='style3'></span></td>";
                    GridList.Text += "  <td width='10%' height='28'><span class='style3'></span></td>";
                    GridList.Text += "  <td width='41%' height='28'><span class='style3'></span></td>";
                    GridList.Text += "  <td width='6%' height='28'><span class='style3'></span></td>";
                    GridList.Text += "  <td width='6%' height='28'><span class='style3'></span></td>";
                    GridList.Text += "  <td width='6%' height='28'><span class='style3'></span></td>";
                    GridList.Text += "  <td width='5%' height='28'><span class='style3'></span></td>";
