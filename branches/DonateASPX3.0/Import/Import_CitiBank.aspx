<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import_CitiBank.aspx.cs" Inherits="Import_Import_CitiBank" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                <asp:Button ID="btnInput" runat="server"  Width="50mm"
                    Text="匯入『花旗銀行捐款』資料"  CssClass="npoButton npoButton_Export"
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                2.相關欄位說明請下載&nbsp;<a href='example/花旗銀行參考範例.csv'>參考範例</a>&nbsp;。
            </td> 
        </tr>
    </table>
    </div>
