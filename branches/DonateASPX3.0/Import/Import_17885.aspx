<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import_17885.aspx.cs" Inherits="Import_Import_17885" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                <asp:Button ID="btnInput" runat="server"  Width="45mm"
                    Text="匯入『智邦捐款』資料"  CssClass="npoButton npoButton_Export"
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                ...
                4.相關欄位說明請下載&nbsp;<a href='example/智邦公益參考範例.xls'>參考範例</a>&nbsp;。
            </td> 
        </tr>
    </table>
    </div>
