...
public partial class Import_Import_TWMF : BasePage
{
    ...
    private void SaveOrInsertSheet(string excel_filename, Worksheet ws)
    {
        ...
        {
            //範圍裡第4格的值
            string Cellular_Phone = ((object[,])this.aRange.Value2)[1, 4] != null ? ((object[,])this.aRange.Value2)[1, 4].ToString() : "";
            ...
            {
                string Donate_Date_temp = ((object[,])this.aRange.Value2)[1, 6] != null ? ((object[,])this.aRange.Value2)[1, 6].ToString() : "";
                ...
                else if(tbxDonate_Date.Text.Trim() !="")
                {
                    Donate_Date = tbxDonate_Date.Text.Trim();
                }
                else
                {
                    Donate_Date = null;
            ...
            //範圍裡第7格的值
            string Excel_No = Donate_Date + " " + ((object[,])this.aRange.Value2)[1, 7] != null ? ((object[,])this.aRange.Value2)[1, 7].ToString() : "";
            //範圍裡第8格的值
            string Remark = ((object[,])this.aRange.Value2)[1, 8] != null ? "帳單月份：" + ((object[,])this.aRange.Value2)[1, 8].ToString() + "\r\n" : "";
            //範圍裡第9格的值
            string InvoiceYN = ((object[,])this.aRange.Value2)[1, 9] != null ? ((object[,])this.aRange.Value2)[1, 9].ToString() : "";
            //範圍裡第10格的值
            string Donor_Name = ((object[,])this.aRange.Value2)[1, 10] != null ? ((object[,])this.aRange.Value2)[1, 10].ToString() : "";
            //範圍裡第11格的值
            string Title = ((object[,])this.aRange.Value2)[1, 11] != null ? ((object[,])this.aRange.Value2)[1, 11].ToString() : "";
            string Sex="";
            if (Title == "小姐")
            {
                Sex = "女";
            ...
            //範圍裡第12格的值
            string Address_temp = ((object[,])this.aRange.Value2)[1, 12] != null ? ((object[,])this.aRange.Value2)[1, 12].ToString() : "";
            ...
            //範圍裡第13格的值
            Remark += ((object[,])this.aRange.Value2)[1, 13] != null ? "帳單週期：" + ((object[,])this.aRange.Value2)[1, 13].ToString() + "\r\n" : "";
            ...
            {
                Donor_AddNew(Donor_Name, Cellular_Phone, Title, Sex, ZipCode, City, Area, Address, InvoiceYN);
            ...
            //新增此次捐款資料
            Donate_AddNew(Donor_Name, Donate_Date, Donate_Amt, Remark, Excel_No);
            //修改捐款人的捐款資料
        ...
        string alert = "alert('台哥大捐款資料匯入成功 ！共計：" + count + "筆，金額：" + Amount_Total + "元');</script>";
        this.ClientScript.RegisterStartupScript(this.GetType(), "js", "<script language='javascript'>" + alert);
    }
    //---------------------------------------------------------------------------
    public void Donor_AddNew(string Donor_Name, string Cellular_Phone, string Title, string Sex, string ZipCode, string City, string Area, string Address, string InvoiceYN)
    {
        ...
        if (InvoiceYN == "Y" || InvoiceYN == "是" || InvoiceYN == "要")
        {
            dict.Add("Invoice_Type", "年度證明及收據");
        }
        else
        {
            dict.Add("Invoice_Type", "不需要");
        }
        ...
        dict.Add("NickName", "");
        dict.Add("Title2", "");
        dict.Add("Invoice_Title", Donor_Name);
        dict.Add("Invoice_IDNo", "");
    ...
    public void Donate_AddNew(string Donor_Name, string Donate_Date, string Donate_Amt, string Remark, string Excel_No)
    {
        ...
        dict.Add("Donate_Payment", "台哥大5180");
