...
public partial class DonateMgr_PledgeReturnError_Print_Excel2 : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        string strSql = @"select ROW_NUMBER() OVER(ORDER BY P.Pledge_Id) AS '序號',P.Pledge_Id as '授權編號'
                            ...
                            ,SR.Return_Status_No as '授權失敗碼' ,SR.Authorization_Messages as '授權失敗原因'
    ...
    private string GetTitle(DataRow dr)
    {
        ...
        string strTitle = "國泰世華授權失敗回覆檔暨捐款人資料<br/> ";
