<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Donate_Add.aspx.cs" Inherits="DonateMgr_Donate_Add" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        function CheckFieldMustFillBasic() {
            ...
            //if ($('#ddlDonate_Payment option:selected').text() == "信用卡授權書") {
            ...
            //20140513 Ian_Kao 修改判斷條件
            //if ($('#ddlDonate_Payment option:selected').text() == "帳戶轉帳授權書") {
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="2">
                <asp:TextBox runat="server" ID="tbxInvoice_Title" CssClass="font9" Width="210px" onblur="CheckDonorNameLen('2',this.value);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:TextBox ID="tbxInvoceSend_Date" runat="server" onchange="CheckDateFormat(this, '收據寄送日期');"></asp:TextBox>
