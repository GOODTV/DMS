...
public partial class DonateMgr_PledgeQry_Print_Excel : BasePage
{
    ...
    private void Print_Excel(string strSql)
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "Pledge");
    }
    //---------------------------------------------------------------------------
    ...
    private string GetTable1(DataRow dr, string strSql)
    {
        ...
        DataTable dtRet = CaseUtil.PledgeQry_Print_Excel(dt);
