<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Donate_Merge.aspx.cs" Inherits="DonateMgr_Donate_Merge" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //2014/4/30 Add by GoodTV Tanya:增加「全選」的功能
    ...
    <script type="text/javascript">
        ...
        function Transfer_OnClick() {
            if (window.confirm('您是否確定要合併捐款資料？') == true) {
                if (document.getElementById("ckEmail").checked == true) {
                    document.getElementById("hfCheckEmail").value = "Emailok";
                }
                else {
                    document.getElementById("hfCheckEmail").value = "";
                }
                return true
            }
            else {
...
<body class="body">
    <form id="Form1" runat="server">
        <asp:HiddenField ID="hfInvoice_Title" runat="server" />
        <asp:HiddenField ID="hfInvoice_Type" runat="server" />
        <asp:HiddenField ID="hfCheckEmail" runat="server" />
    <div id="menucontrol">
