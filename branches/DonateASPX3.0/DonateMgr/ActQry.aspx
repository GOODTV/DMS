<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActQry.aspx.cs" Inherits="DonateMgr_ActQry" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        <tr>
            ...
            <td  align="left" colspan="1" >
                <asp:TextBox runat="server" ID="tbxAct_Name" CssClass="font9" Width="200px"></asp:TextBox>
            </td>
