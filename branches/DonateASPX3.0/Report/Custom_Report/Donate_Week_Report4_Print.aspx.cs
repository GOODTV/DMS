...
public partial class Report_Custom_Report_Donate_Week_Report4 : BasePage
{
    ...
    private void PrintReport()
    {
        ...
        DataTable dtRet = CaseUtil.Donate_Week_Report4_Print(dt,dt2,false);
        ...
        GridList.Text = "週報用大額捐款人明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>捐款期間：" + HFD_DonateDateS_week4.Value + "~" + HFD_DonateDateE_week4.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款日期排序</span><br>" + htw.InnerWriter.ToString();
    ...
    private string Sql()
    {
        ...
        strSql += @"      ,Case When M.Donor_Name like '%主知名' then CONVERT(VARCHAR, D.Donate_Date, 111 ) ELSE CONVERT(VARCHAR, Begin_DonateDate, 111 ) END AS '首捐日期'
							     ...
							     ,Case When Tel_Office_Loc Is Null Or Tel_Office_Loc = ''   
										...
										Else '(' + Tel_Office_Loc + ')' + Tel_Office + ' <br>Ext.' + Tel_Office_Ext End) End '電話' ,IsNull(Cellular_Phone,'') AS '手機',IsNull(Email,'') AS 'Email'   
							FROM dbo.DONOR M  
