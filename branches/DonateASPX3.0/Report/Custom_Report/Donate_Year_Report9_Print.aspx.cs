...
public partial class Report_Custom_Report_Donate_Year_Report9_Print : BasePage
{
    ...
    private void PrintReport()
    {
        ...
        GridList.Text = "中國捐款總額明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計期間：" + HFD_DonateDateS_year9.Value + "~" + HFD_DonateDateE_year9.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人編號排序</span><br>" + htw.InnerWriter.ToString();
