...
public partial class Report_Custom_Report_Donate_Month_Report5_Print_Excel : BasePage
{
    ...
    private void Print_Excel()
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "donate_month_report5");
    }
    //---------------------------------------------------------------------------
    private string GetTitle(DataRow dr)
    {
        ...
        string strTitle = "捐款方式分析<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>捐款期間：" + HFD_DonateDateS_month5.Value + "~" + HFD_DonateDateE_month5.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款日期排序</span>";
