...
public partial class Report_Custom_Report_Donate_Year_Report6_Print_Excel : BasePage
{
    ...
    private void Print_Excel()
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "donate_year_report6");
    }
    //---------------------------------------------------------------------------
    private string GetTitle(DataRow dr)
    {
        ...
        string strTitle = DateTime.Now.Year + "年 期間單筆捐款金額次數明細表<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計期間：" + HFD_DonateDateS_year6.Value + "~" + HFD_DonateDateE_year6.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人編號排序</span>";
