...
public partial class Report_Custom_Report_Donate_Year_Report8_Print : BasePage
{
    ...
    private void PrintReport()
    {
        ...
        DataTable dtRet = CaseUtil.Donate_Year_Report8_Print(dt,false);
        ...
        GridList.Text = "經常奉獻總額明細表<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計期間：" + HFD_DonateDateS_year8.Value + " ~ " + HFD_DonateDateE_year8.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人編號排序</span><br>" + htw.InnerWriter.ToString();
