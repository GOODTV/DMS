...
public partial class Report_Donate_Month_Report4_Print : BasePage
{
    ...
    private void PrintReport()
    {
        ...
        DataTable dtRet = CaseUtil.Donate_Month_Report4_Print(dt,false);
        ...
        GridList.Text = "捐款人EMAIL明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計日期：" + DateTime.Now.ToString() + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依累計奉獻金額排序</span><br>" + htw.InnerWriter.ToString();
