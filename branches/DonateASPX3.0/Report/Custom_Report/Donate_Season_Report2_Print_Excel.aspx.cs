...
public partial class Report_Custom_Report_Donate_Season_Report2_Print_Excel :BasePage
{
    ...
    private void Print_Excel()
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "donate_season_report2");
    }
    //---------------------------------------------------------------------------
    private string GetTitle(DataRow dr)
    {
        ...
        string strTitle = "單筆捐款金額明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計日期：" + HFD_DonateDateS_season2.Value + "~" + HFD_DonateDateE_season2.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依累計奉獻金額排序</span>";
