...
public partial class Report_Custom_Report_Donate_Year_Report3_Print_Excel : BasePage
{
    ...
    private void Print_Excel()
    {
        ...
        //GetTableFooter();
        Util.OutputTxt(GridList.Text, "1", "donate_year_report3");
    }
    //---------------------------------------------------------------------------
    private string GetTitle(DataRow dr)
    {
        ...
        string strTitle = "國外捐款總額明細<br/>" + "<span  style=' font-size: 9pt; font-family: 新細明體'>統計期間：" + HFD_DonateDateS_year3.Value + "~" + HFD_DonateDateE_year3.Value + "</span><br><span  style=' font-size: 9pt; font-family: 新細明體'>依捐款人編號排序</span>";
