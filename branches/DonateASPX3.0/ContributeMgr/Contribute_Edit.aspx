<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contribute_Edit.aspx.cs" Inherits="ContributeMgr_Contribute_Edit" %>
...
<head id="Head1" runat="server">    
    ...
    <script type="text/javascript">
        ...
        function Contribute_Cancel_OnClick(i) {
            ...
            var HFD_Goods_Id = document.getElementById('HFD_Goods_Id_' + i);
            if (Goods_Name.value != '') {
        ...
        function CheckFieldMustFillBasic() {
            ...
            if (window.confirm("您是否確定要修改?") == true) {
                return true;
            }
            else {
                return false;
...
<body class="body">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:TextBox ID="tbxContribute_Date" onchange="CheckDateFormat(this, '捐贈日期');" runat="server" ></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:TextBox ID="tbxDept" runat="server" BackColor="#FFE1AF" CssClass="font9" 
                    ReadOnly="True"></asp:TextBox>
            </td>
            <th align="right" colspan="1">
                收據抬頭：
        ...
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:TextBox ID="tbxAccoun_Date" onchange="CheckDateFormat(this, '沖帳日期');" runat="server" ></asp:TextBox>
        ...
        <tr>
         ...
         <tr>
            ...
            <th colspan="1" align="center" width="6%" >
                清除
            </th>
         </tr>
         <tr>
            ...
            <td colspan="1" align="center">
                <asp:TextBox ID="tbxGoods_DueDate_1" onchange="CheckDateFormat(this, '物品保存期限');" runat="server" Width="120px" ></asp:TextBox>
         ...
         <tr>
            ...
            <td colspan="1" align="center">
                <asp:TextBox ID="tbxGoods_DueDate_2" onchange="CheckDateFormat(this, '物品保存期限');" runat="server" Width="120px" ></asp:TextBox>
         ...
         <tr>
            ...
            <td colspan="1" align="center">
                <asp:TextBox ID="tbxGoods_DueDate_3" onchange="CheckDateFormat(this, '物品保存期限');" runat="server" Width="120px" ></asp:TextBox>
         ...
         <tr>
            ...
            <td colspan="1" align="center">
                <asp:TextBox ID="tbxGoods_DueDate_4" onchange="CheckDateFormat(this, '物品保存期限');" runat="server" Width="120px" ></asp:TextBox>
         ...
         <tr>
            ...
            <td colspan="1" align="center">
                <asp:TextBox ID="tbxGoods_DueDate_5" onchange="CheckDateFormat(this, '物品保存期限');" runat="server" Width="120px" ></asp:TextBox>
