<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsList_Edit.aspx.cs" Inherits="ContributeMgr_GoodsList_Edit" %>
...
<body class="body">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
        <tr>
            ...
            <td align="left" colspan="1">
                <asp:TextBox ID="tbxGoods_Id" runat="server" BackColor="#FFE1AF" ReadOnly="True"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th align="right" colspan="1">
        ...
        <tr>
            ...
            <td align="left" colspan="5">
                <asp:TextBox ID="tbxGoods_Qity" runat="server" BackColor="#FFE1AF" ReadOnly="True"></asp:TextBox>
            </td> 
        </tr>
        <tr>
    ...
    <div class="function">
        <asp:Button ID="btnEdit" class="npoButton npoButton_Modify" runat="server" OnClientClick= "return CheckFieldMustFillBasic(); "
            Text="存檔" onclick="btnEdit_Click"/>
        <asp:Button ID="btnDel" class="npoButton npoButton_Del" runat="server" 
            Text="刪除" onclick="btnDel_Click" OnClientClick= "return confirm( '您是否確定要刪除？'); "/>
