    ...
    <div id="menucontrol">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
           <tr>
               ...
               <td width="85%">
                   <asp:TextBox ID="txtUserID" Width="30mm" CssClass="font9T"  BackColor="#FFE1AF" ReadOnly="True" runat="server"></asp:TextBox>
               </td>
           </tr>
           <tr>
               <th align="right">使用者名稱：</th>
               <td>
                   <asp:TextBox ID="txtUserName" Width="30mm" CssClass="font9T"  BackColor="#FFE1AF" ReadOnly="True" runat="server"></asp:TextBox>
               </td>
           </tr>
           <tr>
