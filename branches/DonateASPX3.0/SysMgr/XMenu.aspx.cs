...
public partial class XMenu : BasePage
{
    ...
    public string CreateMenuList(DataTable dt)
    {
        ...
        MenuListSb.AppendLine("<li><a href=\"JavaScript:if(confirm('是否確定要登出 ?')){window.location.href='../Default.aspx?logout=true&UserID=" + SessionInfo.UserID + "';} \" target='_top'>登出</a></li>");
