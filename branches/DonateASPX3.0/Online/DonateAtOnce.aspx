<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonateAtOnce.aspx.cs" Inherits="Online_DonateAtOnce" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //else 
            ...
            //限制輸入數字
            $('#txtPhoneCode,#txtCorpPhone,#txtExt,#txtCellPhone,#txtFaxCode,#txtFax,#txtLiveZip,#txtLane,#txtAlley,#txtHouseNo,#txtFloor,#txtFloorSub').not('').bind("keyup", function (e) {
                var val = $(this).val();
                //if (isNaN(val)) {
...
<body style="background-color: #EEE" onkeydown="if(event.keyCode==13) return false;">
    <form id="Form1" runat="server">
        ...
        <asp:HiddenField ID="cubkey" runat="server" value=""/>
            ...
            <tr>
                <td>
                    <table border="0" align="center" cellpadding="0" cellspacing="1" class="table_v2">
                        <tr>
                            <th align="right">
                                <span class="necessary">※奉獻金額：</span>
                            </th>
                            <td colspan="3">NT$<asp:TextBox ID="txtAmount" runat="server" MaxLength="100"></asp:TextBox>元<asp:Label ID="lblAmount" runat="server"></asp:Label>　<span id="sAmount" style="color: blue; font-weight: bold; font-size: 14px;">最低金額為100元</span></td>
                        </tr>
                        <tr>
                            <th align="right">
                        ...
                        <asp:TextBox ID="txtLiveStreet" runat="server" Width="30mm" MaxLength="10"></asp:TextBox>
                                ...
                                段
                        <asp:TextBox ID="txtLane" runat="server" Width="15mm" MaxLength="10"></asp:TextBox>
                                巷
                        <asp:TextBox ID="txtAlley" runat="server" Width="15mm" MaxLength="10"></asp:TextBox>
                                弄
                        <span id="sHouse">
                            <asp:TextBox ID="txtHouseNo" runat="server" Width="15mm" MaxLength="10"></asp:TextBox>
                            <%-- 之
                        <asp:TextBox ID="txtHouseNoSub" runat="server" Width="10mm" BackColor="#CCEEFF" MaxLength="10"></asp:TextBox>--%>
                            號
                        </span>
                                <asp:Label ID="lblHousePoint" runat="server"></asp:Label>
                                <span id="sFloor">
                                    <asp:TextBox ID="txtFloor" runat="server" Width="15mm" MaxLength="10"></asp:TextBox>
                                    樓之
                        <asp:TextBox ID="txtFloorSub" runat="server" Width="15mm" MaxLength="10"></asp:TextBox>
                                </span>
                                <asp:Label ID="lblFloorPoint" runat="server"></asp:Label>
                                -
                        <asp:TextBox ID="txtRoom" runat="server" Width="10mm" MaxLength="10"></asp:TextBox>
                                室
                        <br />Attn(收件單位/收件人)：<asp:TextBox ID="txtAttn" runat="server" Width="40mm"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <%-- <tr>
                            ...
                            <td colspan="2">
                                <span style="font-size: 15px">歡迎上GOODTV官網閱讀好消息月刊 <a href="http://www.goodtv.tv/good-news" target="_blank">http://www.goodtv.tv/good-news</a></span>
                            </td>
                        </tr>--%>
                        <tr>
                            <th align="right">注意事項：
                            </th>
                            <td colspan="3">本基金會(好消息電視台)向您蒐集上開個人資料將妥善保護，只供本會營運業務相關服務使用，依個資法第3條所定權利，您可向本會請求查詢、閱覽、複製、補充、停止或刪除。捐款服務組聯絡電話(02)8024-3911、Email：ds@goodtv.tv</td>
                        </tr>
                    </table>
                </td>
            </tr>
