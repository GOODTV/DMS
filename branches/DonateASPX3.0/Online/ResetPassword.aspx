...
<body style="background-color: #EEE">
    <form id="form1" runat="server">
        ...
        <div style="text-align: center">
        <strong><font color="#003399">請填入您的e-mail及姓名，我們會把密碼送到原先設定的e-mail信箱。</font></strong>
        </div>
                ...
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="100">
                                <asp:Button ID="Button2" runat="server" class="Online Online_Button3" Text="取消" OnClick="Button2_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
