...
public partial class Online_DonateRetURL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //20151014增加填寫問卷
        //ClientScript.RegisterStartupScript(this.GetType(), "s", "<script>if (confirm('感謝您的奉獻！您的寶貴意見將可以協助我們提供更優質的捐款服務。您願意現在填寫奉獻問卷調查嗎？')){window.open('OnlineQuestionnaire.aspx?OrderNumber=" + OrderNumber + "&Donor_Id=" + Donor_Id + "&Device=2', 'window','HEIGHT=570,WIDTH=550,top=50,left=50,toolbar=yes,scrollbars=yes,resizable=yes'); }else {alert('非常感謝您的奉獻！'); };</script>");
    }
}