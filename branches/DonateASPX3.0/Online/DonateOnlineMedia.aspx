<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonateOnlineMedia.aspx.cs" Inherits="Online_DonateOnlineMedia" %>
        ...
        <tr>
            ...
            <td width="200" align="left" valign="top" bgcolor="#FFFFFF">
                <table width="200%" border="0" cellspacing="1" cellpadding="1">
                    ...
                    <tr>
                        <td>
                            <img alt="" src="images/btn_優質媒體奉獻_don.jpg" width="120" height="36" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="DonateOnlineOther.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('btn_4','','images/btn_其他_don.jpg',1)">
                                <img alt="其他頁面" src="images/btn_其他_on.jpg" name="btn_4" width="120" height="35" border="0" id="btn_4" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td width="700" align="left" valign="top" bgcolor="#FFFFFF">
                <table width="700" border="0" align="left" cellpadding="1" cellspacing="1">
                    <tr>
                        <td colspan="2" style="text-align:center" align="center" valign="middle" bgcolor="#5F8FB3">
                            <font color="#FFFFFF" size="+1">優　質　媒　體　奉　獻</font>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">
                            <font size="+1" color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;媒體傳播發揮成效</font>
                        </td>
                    </tr>
                    <tr>
...
<%--                    <tr>
                    ...
                    <tr>
                        <td height="176" colspan="2" align="center">
                            <img src="images/pic_媒體.jpg" width="700" height="100" />
                        </td>
                    </tr>
                </table>
            </td>
