    ...
    <div id="mid">
      <div id="mid-1">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="page_form">
          <form action="ecbank_vacc_vaccno.asp" method="post" name="ecbank">
            ...
            <tr>
              <td align="center" colspan="2"><span class="msgshow">◎您即將透過綠界科技銀行虛擬帳號付費系統捐出<%=FormatNumber(Request.Form("Donate_Amount"),0)%>元，是否確定？</span></td>
            </tr>            
            <tr>
            ...
            <%End If%>
            <tr>
              <td align="center" colspan="2"><input type="button" value=" 下一步 " name="But_Dn" class="cbutton" style="cursor:hand;" onClick="javascript:Vacc_OnClick();"></td>
            </tr>
          </form>
        </table>     
      </div>
