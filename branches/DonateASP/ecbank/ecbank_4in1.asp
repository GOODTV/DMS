    ...
    <div id="mid">
      <div id="mid-1">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="page_form">
          <form action="ecbank_4in1_payno.asp" method="post" name="ecbank">
          	<input type="hidden" name="action" value="">
            <input type="hidden" name="amt" value="<%=Request.Form("Donate_Amount")%>">
            <input type="hidden" name="od_sob" value="<%=od_sob%>">
            <input type="hidden" name="purpose" value="<%=Request.Form("Donate_Purpose")%>">
            <input type="hidden" name="donatename" value="<%=Request.Form("Donate_Name")%>">
            <input type="hidden" name="Donate_Desc" value="<%=Request.Form("Donate_Desc")%>">
            <input type="hidden" name="payment_type" value="<%=Request.Form("payment_type")%>">
            <tr>
              <td align="center" colspan="2"><span class="msgshow">◎您即將透過綠界科技便利商店付費系統捐出<%=FormatNumber(Request.Form("Donate_Amount"),0)%>元，是否確定？</span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="contents"><%=FormatNumber(Request.Form("Donate_Amount"),0)%>元(<%=Request.Form("Donate_Desc")%>捐款)&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="right" class="contents">收據身分證/統編：&nbsp;</td>
            ...
            <%End If%>
            <tr>
              <td align="center" colspan="2"><input type="button" value=" 下一步 " name="But_Dn" class="cbutton" style="cursor:hand;" onClick="javascript:FourInOne_OnClick();"></td>
            </tr>
          </form>
        </table>     
      </div>
