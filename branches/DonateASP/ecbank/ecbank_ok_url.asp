        ...
        If Not RS2.EOF Then
          ...
          If RS3.EOF Then
            ...
            If Request.Form("amt")<>"" Then
              If Request.Form("payment_type")="barcode" Then
                Donate_Fee=25
              Else
                Donate_Fee=30
              End If
            ...
            RS4("Donate_AccouS")="0"
            If Request.Form("payment_type")="barcode" Then
              RS4("Donate_Payment")="超商條碼"
            ElseIf Request.Form("payment_type")="ibon" Then
              RS4("Donate_Payment")="7-11Ibon"
            ElseIf Request.Form("payment_type")="cvs" Then
              If Request.Form("payfrom")="family" Then
                RS4("Donate_Payment")="全家FamiPort"
              ElseIf Request.Form("payfrom")="hilife" Then
                RS4("Donate_Payment")="萊爾富LiftET"
              ElseIf Request.Form("payfrom")="okgo" Then
                RS4("Donate_Payment")="OK超商OKGO"
              End If                
            End If
