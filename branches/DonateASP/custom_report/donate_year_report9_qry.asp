                        ...
                        <tr>
                          <td>
							...
							SQL1="SELECT D.Donor_Id AS '編號'  " & _
								    ...
								    ",IsNull(OverseasCountry,'') + ' ' +IsNull(OverseasAddress,'') AS '地址' " & _
							  ...
							  If Request("Donate_Date_Begin")<>"" and Request("Donate_Date_End")<>"" Then 
								SQL1=SQL1&"where Donate_Date>='"&Request("Donate_Date_Begin")&"' And Donate_Date<='"&Request("Donate_Date_End")&"' "
							  Else
								SQL1=SQL1
							  End If
							  ...
							  Else
								SQL1=SQL1&"GROUP BY Donor_Id Having SUM(Donate_Amt) > 0 ) D "
							  End IF
							  
							  SQL1=SQL1&"ON M.Donor_Id = D.Donor_Id " & _
										"WHERE M.IsAbroad = 'Y' " & _
                            ...
                            If request("action")="report" Then
					                    Response.Redirect "../include/movebar.asp?URL=../custom_report/donate_year_report9_rpt.asp"
					                  ElseIf request("action")="export" then
					                    Response.Redirect "donate_year_report9_rpt.asp?action=export"
					                  End If 
