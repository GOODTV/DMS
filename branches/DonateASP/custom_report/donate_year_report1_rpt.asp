...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_year_report1.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>捐款用途總額明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      ...
      Response.Write "  		    <td style='width:35mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='left'>地址</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='left'>首捐日期</td>"&vbcrlf
      ...
      While Not RS1.EOF
        ...
        For I = 0 To FieldsCount
          ...
          ElseIf I=1 or I=2 or I=4 or I=5 Then
		...
		If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  ...
			  If Row<RS1.Recordcount Then
				...
				'Response.Write "  	      <td style='width=120mm;' align='left' class='List_Name'>累計&nbsp;&nbsp;&nbsp;捐款金額:"&FormatNumber(Donate_Total,0)&"元&nbsp;&nbsp;&nbsp;</td>"&vbcrlf
			  Else
      ...
      Session.Contents.Remove("Donor_Purpose")
    End If  
  %>
  </center></div></p>
</body>
