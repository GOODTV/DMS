...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_other_report3.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>雷同資料查詢</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>查詢日期:"&Date()&"</td>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='right' class='Title_Name'>依捐款人姓名或地址排序</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>性別</td>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:25mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='left'>通訊地址</td>"&vbcrlf
	  Response.Write "  		    <td style='width:25mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='left'>收據地址</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      ...
      Session.Contents.Remove("Is_SameName")
	  Session.Contents.Remove("Is_SameAddress")
