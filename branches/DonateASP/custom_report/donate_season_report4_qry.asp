                        ...
                        <tr>
                          <td>
							...
							SQL1="SELECT D.Donor_Id AS '編號'  " & _
									...
									",Case When IsSendNews='Y' Then '寄' Else '不寄' End '刊物原則' ,IsNull(IsSendNewsNum,0) AS '月刊份數' " & _
									"FROM dbo.DONOR M " & _
                            ...
                            If request("action")="report" Then
					                    Response.Redirect "../include/movebar.asp?URL=../custom_report/donate_season_report4_rpt.asp"
					                  ElseIf request("action")="export" then
					                    Response.Redirect "donate_season_report4_rpt.asp?action=export"
					                  End If 
