...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_other_report2.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>DVD贈品索取人報表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>贈送日期:"&Session("Gift_Date_Begin")&"～"&Session("Gift_Date_End")&"</td>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>份數</td>"&vbcrlf
	  Response.Write "  		    <td style='width:22mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='center'>資料輸入日期</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      ...
      While Not RS1.EOF
        ...
        If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  Response.Write "  	<tr>"&vbcrlf
			  Response.Write "  	  <td style='height=5mm; border-top: 2px solid #000000;border-left: 2px solid #000000;border-right: 2px solid #000000;border-bottom: 2px solid #000000' colspan='8'>"&vbcrlf
			  ...
			  If Row<RS1.Recordcount Then
				...
				Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>電話</td>"&vbcrlf
				Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>份數</td>"&vbcrlf
				Response.Write "  		    <td style='width:22m; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='center'>資料輸入日期</td>"&vbcrlf
				Response.Write "  	    </tr>"&vbcrlf
			  End If
			End If
		End If
      ...
      Session.Contents.Remove("Gift_Date_Begin")
	  Session.Contents.Remove("Gift_Date_End")
      Session.Contents.Remove("Linked2_Name")
