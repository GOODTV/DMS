...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_month_report1.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>大額捐款人生日查詢表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>統計日期:"&Now()&"</td>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='right' class='Title_Name'>依捐款人生日日期排序</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      ...
      Response.Write "  		    <td style='width:20mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>地址</td>"&vbcrlf
	  Response.Write "  		    <td style='width:20mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>電話</td>"&vbcrlf
	  Response.Write "  		    <td style='width:20mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>手機</td>"&vbcrlf
      Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='left'>生日</td>"&vbcrlf 
      Response.Write "  	    </tr>"&vbcrlf

      FieldsCount=RS1.Fields.Count-1
	  'response.write FieldsCount =10
	  'response.end()
      PageSize=45
      PageNow=1
      PageTotal=1
      ...
      While Not RS1.EOF
        ...
        If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  Response.Write "  	<tr>"&vbcrlf
			  Response.Write "  	  <td style='height=5mm; border-top: 2px solid #000000;border-left: 2px solid #000000;border-right: 2px solid #000000;border-bottom: 2px solid #000000' colspan='11'>"&vbcrlf
			  ...
			  If Row<RS1.Recordcount Then
				...
				'Response.Write "      <table border='0' style='width:190mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
				''Response.Write "  	    <tr>"&vbcrlf
				''Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Year(Date())&"年"&Month(Date())&"月份&nbsp;&nbsp;大額捐款人生日查詢表</td>"&vbcrlf
				''Response.Write "  	    </tr>"&vbcrlf
				''Response.Write "  	    <tr>"&vbcrlf
				''Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>統計日期:"&Now()&"</td>"&vbcrlf
				''Response.Write "  		    <td style='height=5mm;' align='right' class='Title_Name'>依捐款人生日日期排序</td>"&vbcrlf
      ...
      Session.Contents.Remove("Birthday_Month")
      Session.Contents.Remove("Donor_Type")
    End If  
  %>
  </center></div></p>
</body>
