                        ...
                        <tr>
                          <td>
							...
							SQL1="SELECT D.Donor_Id AS '編號'  " & _
								    ...
								    ",IsNull(IsSendNewsNum,0) AS '月刊份數' " & _
								    ...
								    ",Last_DonateDate AS '末捐日期' ,Last_DonateDate AS '末捐日期'  " & _
									"FROM dbo.DONOR M " & _
							  ...
							  If Request("Donate_Year")<>"" Then 
								SQL1=SQL1&"AND DATEPART(YEAR,Donate_Date) = '"&Request("Donate_Year")&"' GROUP BY Donor_Id) D "
							  Else
                            ...
                            If request("action")="report" Then
					                    Response.Redirect "../include/movebar.asp?URL=../custom_report/donate_year_report2_rpt.asp"
					                  ElseIf request("action")="export" then
					                    Response.Redirect "donate_year_report2_rpt.asp?action=export"
					                  End If 
