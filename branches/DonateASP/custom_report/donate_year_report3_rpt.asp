...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_year_report3.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>海外捐款總額明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:17mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>奉獻次數</td>"&vbcrlf
	  Response.Write "  		    <td style='width:30mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='left'>地址</td>"&vbcrlf
      Response.Write "  		    <td style='width:20mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='center'>國別</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
