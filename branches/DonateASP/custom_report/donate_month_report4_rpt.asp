...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_month_report4.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>郵寄電子報明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>統計日期:"&Now()&"</td>"&vbcrlf
      ...
      Response.Write "      <table border='0' style='width:200mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='width:12mm; height=10mm; border-top: 2px solid #000000; border-left: 2px solid #000000' class='Title_Name' align='center'>捐款人編號</td>"&vbcrlf
      Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>天使姓名</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>稱謂</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>身分別</td>"&vbcrlf
	  Response.Write "  		    <td style='width:23mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>累計奉獻金額</td>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>Email</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>首捐日期</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='center'>末捐日期</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
		...
		If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  ...
			  If Row<RS1.Recordcount Then
				...
				'Response.Write "      <table border='0' style='width:200mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
				'Response.Write "  	    <tr>"&vbcrlf
				'Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Year(Date())-1911&"年"&Month(Date())&"月份&nbsp;&nbsp;郵寄電子報明細表</td>"&vbcrlf
				'Response.Write "  	    </tr>"&vbcrlf
				'Response.Write "  	    <tr>"&vbcrlf
				'Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>統計日期:"&Now()&"</td>"&vbcrlf
				'Response.Write "  		    <td style='height=5mm;' align='right' class='Title_Name'>依累計奉獻金額排序</td>"&vbcrlf
      ...
      If (Row+PageSize) Mod PageSize<>0 Then
        ...
        Response.Write "  	        <td style='width=100mm;' align='left' class='List_Name'><b>總計&nbsp;&nbsp;&nbsp;捐款金額:"&FormatNumber(Donate_Total,0)&"元&nbsp;&nbsp;&nbsp;</b></td>"&vbcrlf
        '20140123 Modify:匯出excel移除分頁，報表仍保留分頁
		If request("action")<>"export" Then
		Response.Write "  	        <td style='width=30mm;' align='right' class='List_Name'>頁數:"&PageNow&"/"&PageTotal&"&nbsp;</td>"&vbcrlf
        End If
