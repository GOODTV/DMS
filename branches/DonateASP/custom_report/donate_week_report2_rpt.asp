...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_week_report2.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "      <table border='0' style='width:205mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>查詢單筆捐款金額</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>捐款期間:"&Session("Donate_Date_Begin")&"～"&Session("Donate_Date_End")&"</td>"&vbcrlf
      ...
      Response.Write "      <table border='0' style='width:205mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000; border-left: 2px solid #000000' class='Title_Name' align='center'>序</td>"&vbcrlf
      Response.Write "  		    <td style='width:12mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>捐款人編號</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>捐款日期</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>天使姓名</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>稱謂</td>"&vbcrlf
	  Response.Write "  		    <td style='width:18mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>捐款金額</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>舊/新大額</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>首捐日期</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>累計金額</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>捐款用途</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>郵遞區號</td>"&vbcrlf
	  Response.Write "  		    <td style='width:25mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='left'>地址</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>電話</td>"&vbcrlf
      Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='center'>手機</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      ...
      While Not RS1.EOF
        ...
        For I = 0 To FieldsCount
          ...
          ElseIf I=2 or I=10 then
			Response.Write "  	<td style='height=5mm; border-top: 1px solid #000000' class='List_Name' align='left'>"&Data_Minus(RS1(I))&"</td>"&vbcrlf
		  'ElseIf I=3 Then
		  ...
		  ElseIf I=FieldsCount Then
            Response.Write "    <td style='height=5mm; border-top: 1px solid #000000;border-right: 2px solid #000000' class='List_Name' align='center'>"&Data_Minus(RS1(I))&"</td>"&vbcrlf
          Else
            Response.Write "  	<td style='height=5mm; border-top: 1px solid #000000' class='List_Name' align='center'>"&Data_Minus(RS1(I))&"</td>"&vbcrlf
          End If
        Next
        ...
        If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  Response.Write "  	<tr>"&vbcrlf
			  Response.Write "  	  <td style='height=5mm; border-top: 2px solid #000000;border-left: 2px solid #000000;border-right: 2px solid #000000;border-bottom: 2px solid #000000' colspan='14'>"&vbcrlf
			  ...
			  If Row<RS1.Recordcount Then
				...
				'Response.Write "      <table border='0' style='width:205mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
				'Response.Write "  	    <tr>"&vbcrlf
				'Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Year(Date())-1911&"年"&Month(Date())&"月份&nbsp;&nbsp;海外捐款總額明細表</td>"&vbcrlf
				'Response.Write "  	    </tr>"&vbcrlf
				'Response.Write "  	    <tr>"&vbcrlf
				...
				'Response.Write "  		    <td style='height=5mm;' align='right' class='Title_Name'>依累計奉獻金額排序</td>"&vbcrlf
				'Response.Write "  	    </tr>"&vbcrlf
				'Response.Write "      </table>"&vbcrlf	
				'Response.Write "    </td>"&vbcrlf
				'Response.Write "  </tr>"&vbcrlf
      ...
      Session.Contents.Remove("Donate_Amt")
