...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_season_report4.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>捐款總額明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      ...
      Response.Write "      <table border='0' style='width:200mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='width:18mm; height=10mm; border-top: 2px solid #000000; border-left: 2px solid #000000' class='Title_Name' align='center'>捐款人編號</td>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:12mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>身分別</td>"&vbcrlf
	  Response.Write "  		    <td style='width:20mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>累計奉獻金額</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>奉獻次數</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>郵遞區號</td>"&vbcrlf
	  Response.Write "  		    <td style='width:30mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>地址</td>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>末捐日期</td>"&vbcrlf
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>刊物原則</td>"&vbcrlf
      Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='left'>月刊份數</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
		...
		If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  ...
			  If Row<RS1.Recordcount Then
				Response.Write "  	        <td style='width=170mm;' align='left' class='List_Name'></td>"&vbcrlf
				'Response.Write "  	      <td style='width=120mm;' align='center' class='List_Name'>累計&nbsp;&nbsp;&nbsp;捐款金額:"&FormatNumber(Donate_Total,0)&"元&nbsp;&nbsp;&nbsp;</td>"&vbcrlf
			  Else
				Response.Write "  	        <td style='width=170mm;' align='left' class='List_Name'>&nbsp;總筆數:"&TolRow&"&nbsp;筆</td>"&vbcrlf
      ...
      Session.Contents.Remove("Donate_Total_Amt")
