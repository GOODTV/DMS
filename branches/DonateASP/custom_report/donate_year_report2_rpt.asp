...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_year_report2.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Session("Donate_Year")&"年&nbsp;&nbsp;捐款總額與月刊索取明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      ...
      Response.Write "      <table border='0' style='width:190mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000; border-left: 2px solid #000000' class='Title_Name' align='center'>捐款人編號</td>"&vbcrlf
      Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>捐款人</td>"&vbcrlf
	  ...
	  Response.Write "  		    <td style='width:10mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>月刊份數</td>"&vbcrlf
      Response.Write "  		    <td style='width:25mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='left'>地址</td>"&vbcrlf
      Response.Write "  		    <td style='width:25mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>首捐日期</td>"&vbcrlf
	  Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000; border-right: 3px solid #000000' class='Title_Name' align='left'>末捐日期</td>"&vbcrlf 
      Response.Write "  	    </tr>"&vbcrlf
      ...
      While Not RS1.EOF
        ...
        For I = 0 To FieldsCount
          ...
          ElseIf I=FieldsCount Then
            Response.Write "    <td style='height=5mm; border-top: 1px solid #000000;border-right: 3px solid #000000' class='List_Name' align='left'>"&Data_Minus(RS1(I))&"</td>"&vbcrlf
          Else
