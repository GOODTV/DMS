...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_year_report7.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Session("Donate_Year")&"年&nbsp;&nbsp;新增捐款人總額明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      ...
      Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='center'>最高奉獻金額</td>"&vbcrlf
      ...
      Response.Write "  		    <td style='width:15mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='left'>末捐日期</td>"&vbcrlf 
      Response.Write "  	    </tr>"&vbcrlf
      ...
      While Not RS1.EOF
        ...
        For I = 0 To FieldsCount
          ...
          ElseIf I=3 Then
            Donate_Max=Donate_Max+Cdbl(RS1(I))
            Response.Write "    <td style='height=5mm; border-top: 1px solid #000000' class='List_Name' align='center'>"&Data_Minus(RS1(I))&"元&nbsp;</td>"&vbcrlf                        
      ...
      Session.Contents.Remove("First_DonateYear")
      Session.Contents.Remove("Last_Donate_Date")
