...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_season_report1.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "      <table border='0' style='width:130mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Year(Date())-1911&"年"&Month(Date())&"月份&nbsp;&nbsp;非建台奉獻統計分析表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      ...
      Response.Write "  		    <td style='width:40mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='right'>人數</td>"&vbcrlf
	  Response.Write "  		    <td style='width:40mm; height=10mm; border-top: 2px solid #000000' class='Title_Name' align='right'>筆數</td>"&vbcrlf
      Response.Write "  		    <td style='width:40mm; height=10mm; border-top: 2px solid #000000; border-right: 2px solid #000000' class='Title_Name' align='right'>總金額</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      ...
      While Not RS1.EOF
        ...
        For I = 0 To FieldsCount
          If I=0 Then
            Response.Write "  	<td style='height=5mm; border-top: 1px solid #000000' class='List_Name' align='right'>"&Data_Minus(RS1(I))&"人</td>"&vbcrlf
          'ElseIf I=2 Then
		  ...
		  ElseIf I=FieldsCount Then
            Response.Write "    <td style='height=5mm; border-top: 1px solid #000000;border-right: 2px solid #000000' class='List_Name' align='right'>"&FormatNumber(RS1(I),0)&"元</td>"&vbcrlf
          Else
