...
If request("action")="export" Then
  ...
  Response.AddHeader "content-disposition", "attachment;filename=donate_month_report2.xls"
End If
...
<body class=tool <%If Not RS1.EOF Then%>onload='print();'<%End If%>>
  ...
  <%
    ...
    Else
      ...
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>定期奉獻授權到期明細表</td>"&vbcrlf
      Response.Write "  	    </tr>"&vbcrlf
      Response.Write "  	    <tr>"&vbcrlf
      Response.Write "  		    <td style='height=5mm;' align='left' class='Title_Name'>終止年月:"&Session("Year")&"年"&Session("Month")&"月</td>"&vbcrlf
		...
		If request("action")<>"export" Then
			...
			If (Row+PageSize) Mod PageSize=0 Then
			  ...
			  If Row<RS1.Recordcount Then
				...
				'Response.Write "      <table border='0' style='width:200mm;' cellspacing='0' cellpadding='0'>"&vbcrlf
				'Response.Write "  	    <tr>"&vbcrlf
				'Response.Write "  		    <td style='height=10mm;' align='center' class='Month_Name' colspan='2'>"&Year(Session("Donate_Date_Begin"))-1911&"年"&Month(Session("Donate_Date_Begin"))&"月份&nbsp;&nbsp;定期奉獻授權到期明細表</td>"&vbcrlf
				'Response.Write "  	    </tr>"&vbcrlf
				'Response.Write "  	    <tr>"&vbcrlf
