                    ...
                    <tr>
                      <td width="99%">
                        <table border="1" cellpadding="2" style="border-collapse: collapse" width="100%" height="25" cellspacing="1">
                          <tr>
                            <td class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="../donation/donor_edit.asp?donor_id=<%=request("donor_id")%>">捐款人資料</a></td>
                            <td class="button2-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="../donation/donate_data.asp?donor_id=<%=request("donor_id")%>">捐款記錄</a></td>	
                            <td class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="../donation/pledge_data.asp?donor_id=<%=request("donor_id")%>">轉帳授權書記錄</a></td>	
                            <%If IsContribute="Y" Then%><td class="button2-bg"><img border="0" src="../images/red_arrow.gif" align="texttop">公關贈品記錄</td><%End If%>
                            <%If IsMember="Y" Then%><td class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="../member/signup_data.asp?donor_id=<%=request("donor_id")%>">活動報名</a></td><%End If%>
                    ...
                    <tr>
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="1" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                           <tr>
                            <td align="left">捐款人： <input type="text" name="Donor_Name" size="20" class="font9t" readonly value="<%=Data_Minus(RS("Donor_Name"))%>&nbsp;<%=RS("Title")%>">                        
                              &nbsp;捐款人編號：
                          ...
                          <tr>
                            <td class="td02-c" colspan="2" width="100%"><iframe name="detail" src="gift_data_list.asp?donor_id=<%=request("donor_id")%>" height="420" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
