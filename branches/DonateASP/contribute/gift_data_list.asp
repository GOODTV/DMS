...
<%
Function GiftList (SQL,PageSize,nowPage,ProgID,HLink,LinkParam,LinkTarget,AddLink)  
  ...
  If Not RS1.EOF Then 
    ...
    If AddLink <> "" Then
      Response.Write "<td align='right'><span style='font-size: 9pt; font-family: 新細明體'><img border='0' src='../images/DIR_tri.gif' align='absmiddle'> <a href='" & AddLink & "' target='main'>新增贈品</a></span></td>"
    End If   
...
<%
If request("SQL")="" Then 
  SQL="Select Gift_Id,贈送日期=CONVERT(VarChar,Gift_Date,111),經手人=GIFT.Create_User " & _
      "From GIFT Where Donor_Id='"&request("Donor_Id")&"' " & _
      "Order By CONVERT(VarChar,Gift_Date,111) Desc,Gift_Id Desc"
Else
  SQL=request("SQL")
End If
PageSize=20
...
End If
ProgID="gift_data_list"
HLink="gift_detail.asp?ctype=gift_data&gift_id="
LinkParam="gift_id"
LinkTarget="main"
AddLink="gift_add.asp?ctype=gift_data&donor_id="&request("Donor_Id")
call GiftList (SQL,PageSize,nowPage,ProgID,HLink,LinkParam,LinkTarget,AddLink) 
%>
</body>
</html>
