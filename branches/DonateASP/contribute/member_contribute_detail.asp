...
Function ContributeDataGrid (SQL)
  ...
  While Not RS1.EOF
      ...
      ElseIf I=4 Then
        Goods_Amt=Goods_Amt+CSng(RS1(I))
        Response.Write "<td align=""right""><span style='font-size: 9pt; font-family: 新細明體'>" & FormatNumber(RS1(I),0) & "</span></td>"
...
If request("action")="void" Then
  ...
  If Not RS1.EOF Then
    While Not RS1.EOF
      If RS1("Contribute_IsStock")="Y" And RS1("Goods_IsStock")="Y" And CSng(RS1("Goods_Qty"))>CSng(RS1("Storage_Qty")) Then
        Check_Void=False
        If Goods_Name="" Then
  ...
  If Check_Void Then
    ...
    SQL="DECLARE @last_donatedate2 datetime " & _
        "DECLARE @begin_donatedate2 datetime " & _
        "DECLARE @donate_no2 numeric " & _
        "DECLARE @donate_total2 numeric " & _
        "Select Top 1 @last_donatedate2=Contribute_Date From CONTRIBUTE Where Donor_Id='"&Donor_Id&"' And Issue_Type<>'D' Order By Contribute_Date Desc " & _
        "Select Top 1 @begin_donatedate2=Contribute_Date From CONTRIBUTE Where Donor_Id='"&Donor_Id&"' And Issue_Type<>'D' Order By Contribute_Date " & _
        "Select @donate_no2=Count(*) From CONTRIBUTE Where Donor_Id='"&Donor_Id&"' And Issue_Type<>'D' " & _
        "Select @donate_total2=Isnull(Sum(Contribute_Amt),0) From CONTRIBUTE Where Donor_Id='"&Donor_Id&"' And Issue_Type<>'D' " & _
        "Update DONOR Set last_donatedate2=@last_donatedate2,begin_donatedate2=@begin_donatedate2,donate_no2=@donate_no2,donate_total2=@donate_total2 Where Donor_Id='"&Donor_Id&"'"
...
If request("action")="return" Then
  ...
  If Not RS1.EOF Then
    While Not RS1.EOF
      Goods_Qty_D=CSng(RS1("Goods_Qty_D"))
      Goods_Amt_D=CSng(RS1("Goods_Amt_D"))
      If RS1("Contribute_IsStock")="Y" And RS1("Goods_Id")<>"" Then
        SQL2="Select Goods_Qty From GOODS Where Goods_Id='"&RS1("Goods_Id")&"' And Goods_IsStock='Y'"
        Set RS2 = Server.CreateObject("ADODB.RecordSet")
        RS2.Open SQL2,Conn,1,3
              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;">物品捐贈修改</td>
                      ...
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
                          ...
                          <tr>
                            ...
                            <td width="16% align="left"><input type="text" name="IDNo" size="12" class="font9t" readonly value="<%=RS("Contribute_Date")%>"></td>
