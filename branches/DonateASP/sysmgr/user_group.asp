...
<div align="center">
  <center>
<form name="form" method="POST" action="user_group_list.asp" target="detail">
	...
	<table width="780" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr>
        ...
        <table width="100%"  border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
              <tr>
              <td width="99%" align="right"><a href="user_group_add.asp">新增資料</a> </td>
              </tr>
            <tr>
              <tr>
              <td class="td02-c" width="100%">
              <iframe name="detail" src="user_group_list.asp" height="420" width="100%" frameborder="0" scrolling="auto"></iframe>
              </td>
              </tr>
            <tr>
              <td width="99%" bgcolor="#C0C0C0" height="1"> </td>
              </tr>
            <tr>
          </table></td>
        <td class="table63-bg">&nbsp;</td>
