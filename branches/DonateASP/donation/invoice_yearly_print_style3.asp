    ...
    Else
      ...
      While Not RS1.EOF
        ...
        For P=1 To 2
          ...
          Response.Write "      </tr>"&vbcrlf
          Response.Write "      <tr>"&vbcrlf
          Response.Write "        <td align='center' valign='top' style='height:36mm' colspan='2'>"&vbcrlf
          ...
          Response.Write "              <td style='width:29mm;height:12mm' class='Donate_Desc'>&nbsp;"&RS1("IDNo")&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:12mm' align='center' class='Donate_Desc'>收據地址</td>"&vbcrlf
          Response.Write "              <td style='width:110mm;height:12mm' align='left' class='Donate_Desc'>&nbsp;"&Data_Minus(RS1("Invoice_Address1"))&"</td>"&vbcrlf
          Response.Write "              <td style='width:59mm;height:12mm' align='center' valign='center' colspan='2' rowspan='3'><img border='0' src='"&SEAL_1&"' style='height:30mm'></td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:12mm' align='center' class='Donate_Desc'>捐款金額</td>"&vbcrlf
          If RS1("Donate_Total")<>"" Then
            Response.Write "            <td style='width:169mm;height:12mm' align='left' class='Donate_Desc'>&nbsp;新台幣"&ChineseMoney(RS1("Donate_Total"))&"&nbsp;(NT$"&FormatNumber(RS1("Donate_Total"),0)&")"&vbcrlf
          Else
            Response.Write "            <td style='width:169mm;height:12mm' align='left' class='Donate_Desc'>&nbsp;</td>"&vbcrlf
          End If
          Response.Write "            </tr>"&vbcrlf
