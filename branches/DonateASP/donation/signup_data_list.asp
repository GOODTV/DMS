    ...
    While Not RS1.EOF And I <= RS1.PageSize
      If Hlink<>"" Then
        If RS1(FieldsCount)="Y" Then
          Response.Write "<a href='../member/member_signup_donate_edit.asp?ctype=signup_data&member_act_id="&RS1(FieldsCount-1)&"&ser_no="&RS1(0)&"' target='" & LinkTarget &"'>"
        Else
          Response.Write "<a href='../member/member_signup_edit.asp?ctype=signup_data&member_act_id="&RS1(FieldsCount-1)&"&ser_no="&RS1(0)&"' target='" & LinkTarget &"'>"
        End If
