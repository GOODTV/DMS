    ...
    Else
      ...
      While Not RS1.EOF
        ...
        For P=1 To 3
          ...
          Response.Write "      </tr>"&vbcrlf
          Response.Write "      <tr>"&vbcrlf
          Response.Write "        <td align='left' valign='top' class='Invoice_No'>捐款日期:"&RS1("Donate_Date")&"</td>"&vbcrlf
          ...
          Response.Write "              <td style='width:110mm;height:8mm' class='Donate_Desc'>&nbsp;"&Data_Minus(RS1("Donor_Name"))&"</td>"&vbcrlf
          ...
          Response.Write "              <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;"&Data_Minus(RS1("Invoice_Address2"))&"</td>"&vbcrlf
          Response.Write "              <td style='width:59mm;height:8mm' align='center' valign='center' colspan='2' rowspan='4'><img border='0' src='"&SEAL_1&"' style='height:30mm'></td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          If Cstr(RS1("Donate_Payment"))=DonateDesc Then
            Response.Write "            <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>物資捐贈</td>"&vbcrlf
            Response.Write "            <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;"&RS1("Donate_Desc")&"</td>"&vbcrlf
          Else
            Response.Write "            <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>捐款金額</td>"&vbcrlf
            If RS1("Donate_Amt")<>"" Then
              Response.Write "          <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;新台幣"&ChineseMoney(RS1("Donate_Amt"))&"</td>"&vbcrlf
            Else
              Response.Write "          <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;</td>"&vbcrlf
            End If
          End If
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>指定用途</td>"&vbcrlf
          Response.Write "              <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;"&RS1("Donate_Purpose")&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>備註</td>"&vbcrlf
          If Cstr(RS1("Donate_Payment"))=DonateDesc Then
            If RS1("Donate_Amt2")<>"" Then
              Response.Write "          <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;折合現金：新台幣"&ChineseMoney(RS1("Donate_Amt2"))&"</td>"&vbcrlf
            Else
              Response.Write "          <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;</td>"&vbcrlf
            End If
          Else
            Response.Write "            <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;"&RS1("Donate_Payment")&"</td>"&vbcrlf
          End If
          Response.Write "            </tr>"&vbcrlf
