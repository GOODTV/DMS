    ...
    Else
      ...
      While Not RS1.EOF
        ...
        For P=1 To 3
          ...
          Response.Write "              <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;"&Data_Minus(RS1("Invoice_Address2"))&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          If Cstr(RS1("Donate_Payment"))=DonateDesc Then
            ...
            Response.Write "            <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;"&RS1("Donate_Desc")&"</td>"&vbcrlf
          Else
            Response.Write "            <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>捐款金額</td>"&vbcrlf
            If RS1("Donate_Amt")<>"" Then
              Response.Write "          <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;新台幣"&ChineseMoney(RS1("Donate_Amt"))&"&nbsp;(NT$"&FormatNumber(RS1("Donate_Amt"),0)&")</td>"&vbcrlf
            Else
              Response.Write "          <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;</td>"&vbcrlf
            End If
          End If
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>指定用途</td>"&vbcrlf
          Response.Write "              <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;"&RS1("Donate_Purpose")&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>備註</td>"&vbcrlf
          If Cstr(RS1("Donate_Payment"))=DonateDesc Then
            If RS1("Donate_Amt2")<>"" Then
              Response.Write "          <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;折合現金：新台幣"&ChineseMoney(RS1("Donate_Amt2"))&"</td>"&vbcrlf
            Else
              Response.Write "          <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;</td>"&vbcrlf
            End If
          Else
            Response.Write "            <td style='width:169mm;height:8mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;"&RS1("Invoice_PrintComment")&"</td>"&vbcrlf
          End If
          Response.Write "            </tr>"&vbcrlf
