                ...
                <td valign="top">
                        ...
                        <table border="0" cellpadding="1" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          <tr>
                            ...
                            <%
                              ...
                              Else
                                SQL="Select Dept_Id,Comp_ShortName From DEPT Where (And Dept_Id In ("&Session("all_dept_type")&") Or Comp_Label>'"&Session("comp_label")&"') Order By Comp_Label,Dept_Id"
                              End If
                              FName="Dept_Id"
                  ...
                  　        </td>
                          ...
                          <tr>
                            ...
                            <td align="left" colspan="3"><input type="text" name="Act_Licence" size="35" class="font9" maxlength="80" value="<%=RS("Act_Licence")%>"></td>
                          </tr>
                          <%If IsAct="Y" Then%>
                          <tr>
