...
If request("action")="save" Then
  ...
  If Not RS.EOF then
    response.redirect "donate_sale_edit.asp?ser_no="&RS("ser_no")
  End If  
End If
%>
<%Prog_Id="donate_sale"%>
                      ...
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          <tr>
                            ...
                            %>
                            &nbsp;&nbsp;&nbsp;文宣標題：
                            <input class=font9 size=30 name="Sale_Subject" maxlength="50">
                            &nbsp;&nbsp;&nbsp;列印日期：
                            <%call Calendar("Sale_BeginDate",Date())%> ~ <%call Calendar("Sale_EndDate","")%>
                            </td>
                          </tr>
                          <tr>
                            <td align="right">文宣內容：</td>
                            <td align="left"><textarea rows="6" name="Sale_Content" cols="93" class="font9"></textarea></td>
                          </tr>
