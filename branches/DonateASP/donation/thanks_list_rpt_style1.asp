...
<head>
  ...
  <title><%=ProgDesc("thanks_list")%></title>
  <style>
  <!--
    table.TableGrid{
	    font-size: 13px;
  ...
  <%
    ...
    Else
      ...
      While Not RS1.EOF
        ...
        If EmailMgr_Desc<>"" Then Response.Write Replace(EmailMgr_Desc,"○○○",Data_Minus(RS1("Donor_Name")))
        Response.Write "  </td><td width='5%' valign='top'> </td><tr>"	
        Response.Write "<table>"
        If Row<RS1.Recordcount Then Response.Write "<div class='pagebreak'>&nbsp;</div>"
        	
        SQL2="Select IsThanks From DONOR Where Donor_Id='"&RS1("Donor_Id")&"'"
