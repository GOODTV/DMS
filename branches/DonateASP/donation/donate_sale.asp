...
<body>
  <p><div align="center"><center>
    <form name="form" method="post" action="donate_sale_list.asp" target="detail">
                    ...
                    <tr>
                      ...
                      <td class="td02-c" width="710">
                        ...
                        %>
                      	...
                      	<input type="button" value=" 查 詢 " name="query" class="cbutton" style="cursor:hand" onClick="Query_OnClick()" onKeypress='if(event.keyCode==13){JavaScript:Query_OnClick();}'>&nbsp;&nbsp;
                      	<input type="button" value="歷史資料查詢" name="history" class="cbutton" onClick="History_OnClick()">			
                      </td>
                    </tr>
                    <tr>
                      <td class="td02-c" colspan="2" width="100%"><iframe name="detail" src="donate_sale_list.asp?action=query&dept_id=<%=Session("dept_id")%>" height="380" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                    </tr>
                  </table>
                </td>
                <td class="table63-bg">&nbsp;</td>
