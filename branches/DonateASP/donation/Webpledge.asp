...
<body OnLoad='Window_OnLoad()'>
  <p><div align="center"><center>
    <form name="form" method="post" action="Webpledge_list.asp" target="detail">
      <input type="hidden" name="action">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#EEEEE3">
        <tr>
          <td>
            <table width="980"  border="0" cellspacing="0" cellpadding="0"  align="center" style="background-color:#EEEEE3">
              <tr>
                <td width="5%"> </td>
                <td width="95%">
              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="1" cellspacing="3">
                    ...
                    <tr>
                      <td class="td02-c" colspan="7" width="100%"><iframe name="detail" src="Webpledge_list.asp?status=授權中" height="415" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                    </tr>
                  </table>
                </td>
                <td class="table63-bg">&nbsp;</td>
