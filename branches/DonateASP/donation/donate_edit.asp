...
If request("action")="update" Then
  ...
  If Check_Close Then
    ...
    'Modify by GoodTV Tanya:修改完成，頁面皆導到「捐款人基本資料維護-捐款紀錄」
'    If request("ctype")="donate_data" Then
      Response.Redirect "donate_data.asp?donor_id="&request("donor_id")
'    Else
'      Response.Redirect "donate_detail.asp?donate_id="&request("donate_id")
'    End If
  Else
    session("errnumber")=1
    session("msg")="您輸入的捐款日期『 "&Cstr(request("Donate_Date"))&"』 已關帳無法修改 ！"
  End If
End If
...
If request("action")="delete" Then
  ...
  If Check_Close Then
    ...
    'Modify by GoodTV Tanya:刪除完成，頁面皆導到「捐款人基本資料維護-捐款紀錄」
'    If request("ctype")="donate_data" Then
      Response.Redirect "donate_data.asp?donor_id="&request("donor_id")
'    Else
'      Response.Redirect "donate.asp"
'    End If
  Else
    session("errnumber")=1
    session("msg")="您輸入的捐款日期『 "&Cstr(request("Donate_Date"))&"』 已關帳無法刪除 ！"
  End If  
End If

SQL="Select DONATE.*,Comp_ShortName,Donor_Name=DONOR.Donor_Name,Title=DONOR.Title,Category=DONOR.Category,Donor_Type=DONOR.Donor_Type,InvoiceType=DONOR.Invoice_Type,IDNo=DONOR.Invoice_IDNo, " & _
                      ...
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          ...
                          <tr>
                            ...
                            <td colspan="2"><input type="text" name="Invoice_Title" size="30" class="font9" maxlength="100" value="<%=Data_Minus(RS("Invoice_Title"))%>" onblur="javascript:CheckDonorNameLen('2',this.value);"></td>
                          ...
                          <tr>
                            ...
                            <td align="left" colspan="5"><input type="text" name="Invoice_PrintComment" size="20" class="font9" maxlength="10" value="<%=RS("Invoice_PrintComment")%>"></td>
                          </tr>
                          <tr>
                            <td align="right">捐款備註：</td>
                            <td align="left" colspan="6"><textarea rows="3" name="Comment" cols="45" class="font9"><%=RS("Comment")%></textarea></td>
                          ...
                          <tr>
                            <td align="center" colspan="8">
                               ...
                               &nbsp;&nbsp;
                               <input type="hidden" value=" 刪 除 " name="save" class="cbutton" style="cursor:hand" onClick="Delete_OnClick()">
                               &nbsp;&nbsp;
