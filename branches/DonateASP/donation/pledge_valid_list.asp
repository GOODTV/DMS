...
<%Prog_Id="pledge_valid"%>
<!--#include file="../include/head.asp"-->
<body OnLoad='Window_OnLoad()'>
  <p><div align="center"><center>
    <form name="form" method="post" action="pledge_valid_rpt.asp" target="report">
              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;">信用卡卡號有效日到期列印</td>
              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111">
                    ...
                    <tr>
                      <td class="td02-c" align="right" width="120">信用卡有效月年：</td>
                    ...
                    <tr>
                      <td class="td02-c" align="right">到期通知內容：</td>
                      <td class="td02-c">
                      <%
                        EmailMgr_Id=""
                        SQL1="Select * From EMAILMGR Where EmailMgr_Type='信用卡到期通知' Order By Ser_No Desc"
                        ...
                        If Session("dept_id")="C001" Or Session("dept_id")="C002" Then
                          SQL2="Select * From EMAILMGR Where EmailMgr_Type='信用卡到期通知' And EmailMgr_Subject Like '%北%' Order By Ser_No Desc"
                        ElseIf Session("dept_id")="C003" Or Session("dept_id")="C006" Then
                          SQL2="Select * From EMAILMGR Where EmailMgr_Type='信用卡到期通知' And EmailMgr_Subject Like '%北%' Order By Ser_No Desc"
                        ElseIf Session("dept_id")="C004" Or Session("dept_id")="C007" Then
                          SQL2="Select * From EMAILMGR Where EmailMgr_Type='信用卡到期通知' And EmailMgr_Subject Like '%中%' Order By Ser_No Desc"
                        ElseIf Session("dept_id")="C008" Or Session("dept_id")="C009" Then
                          SQL2="Select * From EMAILMGR Where EmailMgr_Type='信用卡到期通知' And EmailMgr_Subject Like '%南%' Order By Ser_No Desc"
                        End If
                        If SQL2<>"" Then
                        ...
                        SQL="Select EmailMgr_Id=Ser_No,EmailMgr_Subject From EMAILMGR Where EmailMgr_Type='信用卡到期通知' Order By Ser_No Desc"
                        FName="EmailMgr_Id"
...
function Report_OnClick(){
  ...
  if(confirm('※請注意：地此若為空白到期通知將不會列印\n\n您是否確定要將查詢結果列印？')){
...
function View_OnClick(){
  <%call CheckStringJ("EmailMgr_Id","到期信函內容")%>
  window.open('pledge_valid_view.asp?id='+document.form.EmailMgr_Id.value+'','view','toolbar=no,location=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,width=800,height=600');
}
--></script>