              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111">
                    ...
                    <input type="hidden" name="Invoice_Type" value="<%=InvoiceTypeY%>">
                    <input type="hidden" name="Print_Pint" value="1">
                    <%If Invoice_Prog2="6" Then%>
                    <input type="hidden" name="Invoice_Prog" value="<%=Invoice_Prog2%>">	
                    <%Else%>                    	
                    <tr>
                      <td class="td02-c" align="right">收據樣式：</td>
                      <td class="td02-c" colspan="3">
                      <%
                        SQL1="Select Seq,Invoice_Prog=CodeDesc From CASECODE Where CodeType='InvoiceY' Order By Seq"
                        Set RS1 = Server.CreateObject("ADODB.RecordSet")
                        RS1.Open SQL1,Conn,1,1
                        Response.Write "<SELECT Name='Invoice_Prog' size='1' style='font-size: 9pt; font-family: 新細明體'>" 
                        Response.Write "<OPTION>" & " " & "</OPTION>"
                        While Not RS1.EOF
                          If Cstr(RS1("Seq"))=Cstr(Invoice_Prog2) Then
