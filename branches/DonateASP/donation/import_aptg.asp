  ...
  If UploadName<>"" Then
    ...
    While Not RSX.EOF
      If Trim(RSX(0))<>"" Then
        ...
        Else
          If Trim(RSX(0))<>"" Then Donate_Date=Left(Trim(RSX(0)),4)&"/"&Mid(Trim(RSX(0)),5,2)&"/"&Mid(Trim(RSX(0)),7,2)
        End If
        Cellular_Phone=""
        If Trim(RSX(1))<>"" Then Cellular_Phone=Trim(RSX(1))
        If Len(Cellular_Phone)="9" Then Cellular_Phone="0"&Cellular_Phone
        If Trim(RSX(2))<>"" Then 
          Remark=Remark&"品項："&Trim(RSX(2))&vbcrlf
          Excel_No=Trim(RSX(0))&"-"&Trim(RSX(1))&"-"&Split(Trim(RSX(2)),"-")(0)
        End If
        Donate_Amt="0"
        If Trim(RSX(3))<>"" Then Donate_Amt=Trim(RSX(3))
        Donor_Name=""
        If Trim(RSX(4))<>"" Then Donor_Name=Trim(RSX(4))
        Email=""
        ZipCode=""
        City=""
        Area=""
        Address=""
        If Trim(RSX(5))<>"" Then Address=Trim(RSX(5))
        If Address<>"" Then
...
<body OnLoad='Window_OnLoad()'>
  <p><div align="center"><center>
    <form  name="form" action="import_aptg.asp?action=upload" method="post" enctype="multipart/form-data">	
                ...
                <td valign="top">
                  ...
                  　  </td>
                    ...
                    <tr>
                      ...
                      <td class="td02-c">
                      	<input type="radio" name="Date_Type" value="1" checked >依檔案內的『&nbsp;<b>立帳年月</b>&nbsp;』
                    ...
                    <tr>
                      ...
                      <td class="td02-c">
                        ...
                        <input type="button" value="匯入『&nbsp;亞太捐款&nbsp;』資料" name="input" class="addbutton" style="cursor:hand" onClick="Input_OnClick()">
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="td02-c" width="630">
                      	...
                      	4.相關欄位說明請下載&nbsp;<a href='import/亞太參考範例.xls'>參考範例</a>&nbsp;。
                      </td>
                    </tr>
