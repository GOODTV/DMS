                    ...
                    <td class="td02-c" width="100%">
                      <table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                        <tr>
                          <td>
                  	      <%
                            If request("Dept_Id")<>"" And request("Donate_Amt_Kind")<>"" And (request("Stat_KindX")="Donate_Amt" Or request("Stat_KindY")="Donate_Amt")  Then
                            ...
                            Session("Stat_KindX")=request("Stat_KindX")
                            Session("Stat_KindY")=request("Stat_KindY")
                            ...
                            If request("action")="report" Then
					                    Response.Redirect "../include/movebar.asp?URL=../donation/donate_stat_list_rpt2.asp"
					                  ElseIf request("action")="export" then
					                    Response.Redirect "donate_stat_list_rpt2.asp?action=export"
					                  End If 
