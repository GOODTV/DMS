                        ...
                        <tr>
                          <td>
                            ...
                            If request("SQL1")="" Then
                              ...
                              '排序方式
                              OrderBy_Where="Order By Invoice_No,Donate_Date Desc,Donate_Id Desc" 
   						                
   						                SQL1="Select Donate_Id,收據編號=Isnull(Invoice_Pre,'')+Invoice_No,捐款日期=CONVERT(VarChar,Donate_Date,111),捐款人=Donor_Name,捐款金額=Isnull(Donate_Amt,0),捐款用途=Donate_Purpose,捐款方式=Donate_Payment,DONATE.Donor_Id " & _
                                  "From DONATE Join DONOR On DONATE.Donor_Id=DONOR.Donor_Id " & _
                                  "Left Join ACT On DONATE.Act_Id=ACT.Act_Id " & _
                                  "Where Issue_Type<>'D' "&Donate_Where&OrderBy_Where&" "
                            ...
                            If request("action")="report" Then
					                    Response.Redirect "../include/movebar.asp?URL=../donation/donate_month_list_rpt.asp"
					                  ElseIf request("action")="export" then
					                    Response.Redirect "donate_month_list_rpt.asp?action=export"
					                  End If 
