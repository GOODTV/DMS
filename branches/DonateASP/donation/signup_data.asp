              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;">捐款人資料維護</td>
                    ...
                    <tr>
                      <td width="99%">
                        <table border="1" cellpadding="2" style="border-collapse: collapse" width="100%" height="25" cellspacing="1">
                          <tr>
                            <td width="20%" class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="donor_edit.asp?donor_id=<%=request("donor_id")%>">捐款人資料</a></td>
                            <td width="20%" class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="donate_data.asp?donor_id=<%=request("donor_id")%>">捐款記錄</a></td>
                            <td width="20%" class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="pledge_data.asp?donor_id=<%=request("donor_id")%>">轉帳授權書記錄</a></td>
                            <td width="20%" class="button-bg"><img border="0" src="../images/red_arrow.gif" align="texttop"><a class="tool" href="../contribute/contribute_data.asp?donor_id=<%=request("donor_id")%>">物品捐贈記錄</a></td>
                            <td width="20%" class="button2-bg"><img border="0" src="../images/red_arrow.gif" align="texttop">活動報名</td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                    <tr>
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="1" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          ...
                          <tr>
                            <td class="td02-c" colspan="2" width="100%"><iframe name="detail" src="signup_data_list.asp?donor_id=<%=request("donor_id")%>" height="420" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
