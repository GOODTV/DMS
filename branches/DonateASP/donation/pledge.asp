  ...
  <p><div align="center"><center>
    <form name="form" method="post" action="pledge_list.asp" target="detail">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#EEEEE3">
        <tr>
          <td>
          	<!--20131211 Modify by GoodTV Tanya:頁面加寬-->
              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="1" cellspacing="3">
                    <tr>
                      <td class="td02-c" width="10%" align="right">機構：</td>
                      <td class="td02-c" width="12%">
                      <%
                    ...
                    <tr>
                      <td class="td02-c" width="10%" align="right">授權編號：</td>
                      <td class="td02-c" width="10%"><input type="text" name="Pledge_Id" size="10" class="font9" maxlength="10"></td>
                      <!--20131211 Modify by GoodTV Tanya:固定轉帳授權書-查詢條件「捐款人」改為「捐款人編號」-->
                      <td class="td02-c" width="10%" align="right">捐款人編號：</td>
                      <td class="td02-c" width="10%"><input type="text" name="Donor_Id" size="15" class="font9" maxlength="10"></td>
					  <td class="td02-c" width="12%" align="right">捐款授權到期日：</td>
                      <td class="td02-c" width="10%">
                      <%
					  ...
					  <td class="td02-c" width="12%" align="right"></td>
                      <td class="td02-c" width="10%"></td>
                      <td class="td02-c" width="16%" align="right"><input type="button" value="  授權到期通知  " name="from" class="addbutton" style="cursor:hand" onClick="ToDay_OnClick()"></td>
                    </tr>
                    <tr>
                      ...
                      <td class="td02-c" align="right">指定用途：</td>
                      <td class="td02-c">
                      <%
					  ...
					  <td class="td02-c" align="right">卡號/帳號：</td>
                      <td class="td02-c"><input type="text" name="Card_No" size="16" class="font9" maxlength="16">
					  </td>
                    ...
                    <tr>
                      <td class="td02-c" colspan="9" width="100%"><iframe name="detail" src="pledge_list.asp?status=授權中" height="415" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                    </tr>
                  </table>
                </td>
                <td class="table63-bg">&nbsp;</td>
...
function Query_OnClick(){
  ...
  //20140122 Add by GoodTV Tanya:捐款人編號驗證是否填入數字
  if(document.form.Donor_Id.value!=''){  	
  	<%call CheckNumberJ("Donor_Id","捐款人編號")%>
	}	
