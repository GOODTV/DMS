...
If Session("Print_Desc")="1" Then
  SQL1=Replace(SQL1,"Where","Where Donate.Invoice_Title<>'' And Invoice_Address<>'' And ")
Else
  SQL1=Replace(SQL1,"Where","Where Donate.Invoice_Title<>'' And Address<>'' And ")
End If
  ...
  <%
    ...
    Else
      ...
      While Not RS1.EOF
        ...
        Response.write "  <td width='10%' height='30'><span class='style3'>"&RS1("Donor_Name")&"</span></td>"
        If Session("Print_Desc")="1" Then
