    ...
    Else
      ...
      While Not RS1.EOF
        ...
        For P=1 To 2
          ...
          Response.Write "              <td style='width:110mm;height:12mm' align='left' class='Donate_Desc'>&nbsp;"&Data_Minus(RS1("Invoice_Address2"))&"</td>"&vbcrlf
          ...
          If Cstr(RS1("Donate_Payment"))=DonateDesc Then
            ...
            Response.Write "            <td style='width:169mm;height:12mm' align='left' class='Donate_Desc''>&nbsp;"&RS1("Donate_Desc")&"</td>"&vbcrlf
          Else
            Response.Write "            <td style='width:25mm;height:12mm' align='center' class='Donate_Desc'>捐款金額</td>"&vbcrlf
            If RS1("Donate_Amt")<>"" Then
              Response.Write "          <td style='width:169mm;height:12mm' align='left' class='Donate_Desc'>&nbsp;新台幣"&ChineseMoney(RS1("Donate_Amt"))&"</td>"&vbcrlf
            Else
          ...
          Response.Write "              <td style='width:169mm;height:12mm' align='left' class='Donate_Desc'>&nbsp;"&RS1("Donate_Purpose")&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
