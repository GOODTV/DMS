...
While Not RS.EOF
  Row=0
  SQL1="Select Distinct Donate_Amt From DONATE Join Donor On Donor.Donor_Id=Donate.Donor_Id Where Donate_Purpose='"&RS("Donate_Purpose")&"' And Donate_Amt>0 And (Issue_Type Is Null Or Issue_Type='' Or Issue_Type='M') "&Session("SQL_Where")&" Order By Donate_Amt "&Session("Seq_Type")&""
  ...
  While Not RS1.EOF
    ...
    Donor_Id=""
    Invoice_Title=""
    SQL2="Select Donate_Amt,Invoice_Title="&InvoiceTitle&",Donate_Date,Donate.Donor_Id From DONATE Join Donor On Donor.Donor_Id=Donate.Donor_Id Where Donate_Purpose='"&RS("Donate_Purpose")&"' And CONVERT(int,Donate_Amt)='"&RS1("Donate_Amt")&"' And (Issue_Type Is Null Or Issue_Type='' Or Issue_Type='M') "&Session("SQL_Where")&" " & _
