...
If request("action")="upload" Then
  ...
  If UploadName<>"" Then
    ...
    While Not RSX.EOF
      If Trim(RSX(0))<>"" Then
        Excel_No=Row
        Donor_Name=Trim(RSX(0))
        Invoice_Title=Trim(RSX(1))
        If Invoice_Title="" Then Invoice_Title=Donor_Name
        Sex=Trim(RSX(2))
        Cellular_Phone=Trim(RSX(3))
        Donate_Item=Trim(RSX(4))
        ...
        If Trim(RSX(7))="N" Then
          Invoice_Type=InvoiceTypeY
        ElseIf Trim(RSX(7))="Y" Then
          Invoice_Type=InvoiceTypeN
        End If
        IsSendNews="N"
        If Trim(RSX(8))="Y" Then IsSendNews="Y"
        Remark=Trim(RSX(9))
        If Remark="" Then
          If Donate_Item<>"" Then Remark="專案別:"&Donate_Item
        Else
          If Donate_Item<>"" Then Remark=Remark&vbCRLF&"專案別:"&Donate_Item
        End If
        ...
        If Cellular_Phone<>"" Then
          SQL1="Select * From DONOR Where Donor_Name='"&Donor_Name&"' And (Address='"&Address&"' Or Cellular_Phone='"&Cellular_Phone&"')"
        Else
...
<body OnLoad='Window_OnLoad()'>
  <p><div align="center"><center>
    <form  name="form" action="import_tcbank.asp?action=upload" method="post" enctype="multipart/form-data">	
                ...
                <td valign="top">
                  ...
                  　  </td>
                    ...
                    <tr>
                      ...
                      <%If Donate_Date<>"" Then%>
                      <td class="td02-c"><%call Calendar("Donate_Date",Donate_Date)%></td>
                      <%Else%>
                      <td class="td02-c"><%call Calendar("Donate_Date",Date())%></td>
                      <%End If%>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="td02-c">
                        ...
                        <input type="button" value="匯入『&nbsp;大眾銀行&nbsp;』資料" name="input" class="addbutton" style="cursor:hand" onClick="Input_OnClick()">
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="td02-c" width="630">
                      	...
                      	4.相關欄位說明請下載&nbsp;<a href='import/大眾銀行參考範例.xls'>參考範例</a>&nbsp;。<br />
                      </td>
                    </tr>
