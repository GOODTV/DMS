    ...
    Else
      ...
      While Not RS1.EOF
        ...
        For P=1 To 3
          ...
          Response.Write "      </tr>"&vbcrlf
          Response.Write "      <tr>"&vbcrlf
          Response.Write "        <td align='left' valign='top' class='Invoice_No'>捐款年度:"&Session("Donate_Year")&"年度</td>"&vbcrlf
          ...
          Response.Write "              <td style='width:29mm;height:8mm' class='Donate_Desc'>&nbsp;"&RS1("IDNo")&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:8mm' align='center' class='Donate_Desc'>收據地址</td>"&vbcrlf
          Response.Write "              <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;"&Data_Minus(RS1("Invoice_Address1"))&"</td>"&vbcrlf
          ...
          If RS1("Donate_Total")<>"" Then
            Response.Write "          <td style='width:110mm;height:8mm' align='left' class='Donate_Desc'>&nbsp;新台幣"&ChineseMoney(RS1("Donate_Total"))&"&nbsp;(NT$"&FormatNumber(RS1("Donate_Total"),0)&")"&vbcrlf
          Else
