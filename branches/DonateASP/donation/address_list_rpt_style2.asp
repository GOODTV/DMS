  ...
  <%
    ...
    Else
      ...
      While Not RS1.EOF
        ...
        If Row=1 Or Row=2 Or Row=13 Or Row=14 Then
        	Response.Write "<td class='Tablecell_HF'>"
        Else	
          Response.Write "<td class='Tablecell'>"
        End If
        If Session("Print_Desc")="1" Then
          If Data_Minus(RS1("Invoice_Address"))<>"" Then
            Response.Write RS1("Invoice_ZipCode")&"<br />"&Data_Minus(RS1("Invoice_Address"))&"<br />"&Data_Minus(RS1("Donor_Name"))&"&nbsp;"&RS1("title")&"啟"
          Else
            Response.Write RS1("ZipCode")&"<br />"&RS1("Address")&"<br />"&Data_Minus(RS1("Donor_Name"))&"&nbsp;"&RS1("title")&"啟"
          End If  
        Else
          If RS1("Address")<>"" Then
            Response.Write RS1("ZipCode")&"<br />"&RS1("Address")&"<br />"&Data_Minus(RS1("Donor_Name"))&"&nbsp;"&RS1("title")&"啟"
        ...
        If (Row+Col) Mod Col=1 Then Response.Write "<td class='CellMiddle'> </td>"
      ...
      While (Row+Page_Row) Mod Page_Row<>1
        If (Row+Col) Mod Col=1 Then Response.Write "<tr>"
        If Row=1 Or Row=2 Or Row=13 Or Row=14 Then
        	Response.Write "<td class='Tablecell_HF'> </td>"
        Else	
