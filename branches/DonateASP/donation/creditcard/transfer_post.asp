...
'8.總金額
DonateTotalLen=13
If Len(Cstr(Donate_Total))>=DonateTotalLen Then
  Response.Write Left(Cstr(Donate_Total),DonateTotalLen)&"00"
Else
  StrDonateTotal=""
  For J=1 To DonateTotalLen
    StrDonateTotal=StrDonateTotal&"0"
  Next
  'Response.Write Left(StrDonateTotal,DonateTotalLen-Len(Cstr(Donate_Total)))&Donate_Total&"00"
  Response.Write Right(StrDonateTotal&Donate_Total&"00",DonateTotalLen)
End If
'9.保留欄
SpaceLen=16
Response.Write Space(SpaceLen)
