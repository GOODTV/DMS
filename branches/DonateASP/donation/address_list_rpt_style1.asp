    ...
    Else
      ...
      While Not RS1.EOF
        ...
        If Session("Print_Desc")="1" Then
          If Data_Minus(Data_Minus(RS1("Invoice_Address")))<>"" Then
            Response.write RS1("Invoice_ZipCode")&"<br />"&Data_Minus(Data_Minus(RS1("Invoice_Address")))&"<br />"&Data_Minus(Data_Minus(RS1("Donor_Name")))&"&nbsp;"&RS1("title")&"啟"
          Else
            Response.write RS1("ZipCode")&"<br />"&RS1("Address")&"<br />"&Data_Minus(Data_Minus(RS1("Donor_Name")))&"&nbsp;"&RS1("title")&"啟"
          End If
        Else
          If RS1("Address")<>"" Then
            Response.write RS1("ZipCode")&"<br />"&RS1("Address")&"<br />"&Data_Minus(Data_Minus(RS1("Donor_Name")))&"&nbsp;"&RS1("title")&"啟"
        ...
        If Instr(SQL1,"Invoice_Print_Yearly_Add")>0 Then
          SQL2="Update DONATE Set Invoice_Print_Yearly_Add='1' "&Session("Donate_Where")&" And Donor_Id='"&RS1("Donor_Id")&"' And Invoice_Title='"&Data_Minus(Data_Minus(RS1("Donor_Name")))&"'"
      ...
      While (Row+Page_Row) Mod Page_Row<>1
        If (Row+Col) Mod Col=1 Then Response.write "<tr>"
        Response.write "<td class='Tablecell'> </td>"
        If (Row+Col) Mod Col=0 Then Response.write "</tr>"
