  ...
  If UploadName<>"" Then
    ...
    While Not RSX.EOF
      If Trim(RSX(0))<>"" Then
        Remark=""
        Donor_Name=""
        Donate_Payment="7-11Ibon"
        Excel_Type="Ibon"
        Excel_No=Replace(Trim(RSX(0)),"'","")
        If Excel_No<>"" Then Remark=Remark&"交易序號:"&Excel_No&vbcrlf
        Cellular_Phone=Replace(Trim(RSX(1)),"#","")
        If Cellular_Phone<>"" Then
          Remark=Remark&"顯示資料:"&Cellular_Phone&vbcrlf
          Donor_Name=Cellular_Phone
        End If
        If Trim(RSX(4))<>"" Then
          Remark=Remark&"拉單門市-店號:"&Trim(RSX(4))&vbcrlf
          If Donor_Name="" Then Donor_Name=Trim(RSX(4))
        End If
        Donate_Date=""
        If Dept_Date<>"" Then
        ...
        Else
          If Trim(RSX(7))<>"" Then
            DonateDate=CDate(Replace(Trim(RSX(7)),"已拉單",""))
            Donate_Date=Year(DonateDate)&"/"&Month(DonateDate)&"/"&Day(DonateDate)
          End If
        End If
        Donate_Amt="0"
        If Trim(RSX(11))<>"" Then Donate_Amt=Trim(RSX(11))
        ...
        If RS1.EOF Then
          Invoice_Pre=""
          Invoice_No=""
          InvoiceNo=Get_Invoice_No2("1",Dept_Id,Donate_Date,InvoiceTypeN,"")
          If InvoiceNo<>"" Then
...
<body OnLoad='Window_OnLoad()'>
  <p><div align="center"><center>
    <form  name="form" action="import_ibon.asp?action=upload" method="post" enctype="multipart/form-data">	
                ...
                <td valign="top">
                  ...
                  　  </td>
                    ...
                    <tr>
                      ...
                      <td class="td02-c">
                      	<input type="radio" name="Date_Type" value="1" checked >依檔案內的『&nbsp;<b>拉單狀態日期</b>&nbsp;』
                    ...
                    <tr>
                      ...
                      <td class="td02-c">
                        ...
                        <input type="button" value="匯入『&nbsp;Ibon捐款&nbsp;』資料" name="input" class="addbutton" style="cursor:hand" onClick="Input_OnClick()">
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="td02-c" width="630">
                      	...
                      	4.相關欄位說明請下載&nbsp;<a href='import/Ibon參考範例.xls'>參考範例</a>&nbsp;。<br />
                      	5.『&nbsp;<font color="#FF0000">捐款人姓名</font>&nbsp;』將以檔案內顯示資料之『&nbsp;<font color="#FF0000">手機號碼</font>&nbsp;』欄位或『&nbsp;<font color="#FF0000">拉單門市-店號</font>&nbsp;』欄位來代替。
                      </td>
                    </tr>
