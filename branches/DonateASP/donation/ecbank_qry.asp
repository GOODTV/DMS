...
<body>
  <p><div align="center"><center>
    <form name="form" method="post" action="ecbank_qry_list.asp" target="detail">
                  ...
                  <table width="100%" border="0" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                      ...
                      <SELECT Name='Donate_Type' size='1' style='font-size: 9pt; font-family: 新細明體'>
                      	...
                      	<OPTION value='vacc'>銀行虛擬帳號</OPTION>
                      	<OPTION value='barcode'>超商條碼</OPTION>
                      	<OPTION value='ibon'>7-11 ibon</OPTION>
                      	<OPTION value='famiport'>全家 Famiport</OPTION>
                      	<OPTION value='lifeet'>萊爾富 Life-Et</OPTION>
                      	<OPTION value='okgo'>OK超商 OK-GO</OPTION>
                      </SELECT>
                      &nbsp;
                      繳費狀態：
                      <SELECT Name='Close_Type' size='1' style='font-size: 9pt; font-family: 新細明體'>
                      	<OPTION value=''> </OPTION>
                      	<OPTION value='L'>交易失敗</OPTION>
                      	<OPTION value='N'>未付款</OPTION>
                      	<OPTION value='Y'>付款完成</OPTION>
                      </SELECT>
                      </td>
                      <td class="td02-c">
                    ...
                    <tr>
                      <td class="td02-c" colspan="9" width="100%"><iframe name="detail" src="ecbank_qry_list.asp?Donate_Export=N&Donate_CreateDate_B=<%=Donate_CreateDate_B%>" height="380" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                    </tr>
                  </table>
                </td>
                <td class="table63-bg">&nbsp;</td>
