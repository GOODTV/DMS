              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;"><%=Prog_Desc%>輸入</td>
              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                      <td class="td02-c" colspan="9" width="100%">
                      <%
                        If request("action")="query" Then
                          SQL1="Select Donor_Id,編號=(Case When Member_No<>'' Then Member_No Else CONVERT(nvarchar(20),Donor_Id) End),捐款人=(Case When NickName<>'' Then Donor_Name+'('+NickName+')' Else Donor_Name End),類別=Category,身份別=Donor_Type,手機=Cellular_Phone,電話日=Tel_Office,EMail=Email,身份證=IDNo,聯絡人=Contactor,通訊地址=(Case When DONOR.City='' Then Address Else Case When A.mValue<>B.mValue Then DONOR.ZipCode+A.mValue+B.mValue+Address Else DONOR.ZipCode+A.mValue+Address End End),最近捐款日期=CONVERT(VarChar,Last_DonateDate,111) " & _
                          ...
                          If Not RS1.EOF Then
                            ...
                            Response.Write "    <td width='15%' align='right'><span style='font-size: 9pt; font-family: 新細明體'><img border='0' src='../images/DIR_tri.gif' align='absmiddle'><a href='donor_add.asp?ctype=pledge&donor_name2="&request("Donor_Name")&"&tel_office2="&request("Tel_Office")&"&category2="&request("Category")&"&donor_type2="&request("Donor_Type")&"&idno2="&request("IDNo")&"&city2="&request("City")&"&area2="&request("Area")&"&address2="&request("Address")&"' target='main'>新增捐款人資料</a></span></td>"
                            Response.Write "  </tr>"
                            ...
                            Response.Write "</tr>"
                            While Not RS1.EOF
                              Response.Write "<a href='pledge_add.asp?ctype=pledge&donor_id="&RS1(0)&"' target='main'>"
                          ...
                          Else
                            session("errnumber")=1
                            session("msg")="查無相關資料，請先新增捐款人 ！"
                            Response.Redirect "donor_add.asp?ctype=pledge&donor_name2="&request("Donor_Name")&"&tel_office2="&request("Tel_Office")&"&category2="&request("Category")&"&donor_type2="&request("Donor_Type")&"&idno2="&request("IDNo")&"&city2="&request("City")&"&area2="&request("Area")&"&address2="&request("Address")&""
                          End If
                          RS1.Close
                          Set RS1=Nothing 
                        Else
                          ...
                          Response.Write "    <td width='15%' align='right'><span style='font-size: 9pt; font-family: 新細明體'><img border='0' src='../images/DIR_tri.gif' align='absmiddle'> <a href='donor_add.asp?ctype=pledge' target='main'>新增捐款人資料</a></span></td>"
                          Response.Write "  </tr>"
                          Response.Write "</table>"
                        End If
                      %>
