    ...
    Else
      ...
      While Not RS1.EOF
        ...
        For P=1 To 2
          ...
          Response.Write "              <td style='width:110mm;height:12mm' class='Donate_Desc'>&nbsp;"&Data_Minus(Donor_Name)&"</td>"&vbcrlf
          ...
          Response.Write "              <td style='width:169mm;height:12mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;"&Data_Minus(RS1("Invoice_Address1"))&"</td>"&vbcrlf
          Response.Write "            </tr>"&vbcrlf
          Response.Write "            <tr>"&vbcrlf
          Response.Write "              <td style='width:25mm;height:12mm' align='center' class='Donate_Desc'>捐款金額</td>"&vbcrlf
          If RS1("Donate_Total")<>"" Then
            Response.Write "            <td style='width:169mm;height:12mm' align='left' class='Donate_Desc' colspan='3'>&nbsp;"&ChineseMoney(RS1("Donate_Total"))&"&nbsp;(NT$"&FormatNumber(RS1("Donate_Total"),0)&")"&vbcrlf
          Else
