...
<body OnLoad="Window_OnLoad()" onselectstart="return false;" ondragstart="return false;" oncontextmenu="return false;">
  <form name="form" method="POST" action="admin/login.asp">
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="110" background="images/login_bg_01.gif">
            ...
            <tr>
              ...
              <td width="750" height="60" bgcolor="#FFFFFF"><img src="images/logo.png"></td>
            </tr>
          </table>
        </td>
      </tr>
      ...
      <tr>
        <td height="155" background="images/login_bg_03.gif" bgcolor="#FFFFFF">
            ...
            <tr>
              ...
              <td align="left"><input type="submit" value=" 登 入 " name="action" style="cursor:hand;font-family: 新細明體; font-size: 9pt"></td>
            </tr>
          </table>
        </td>
      </tr>
      ...
      <tr>
        <td><img src="images/logo_blank.gif"></td>
      </tr>
    </table>
  </form>
  <%Message()%>
