...
SQL="Select DONATE.*,Donor_Name=DONOR.Donor_Name,Title=DONOR.Title,Category=DONOR.Category,Donor_Type=DONOR.Donor_Type,IDNo=DONOR.IDNo,Member_Type,Member_Act_ShortName, " & _
    "Address2=(Case When DONOR.City='' Then DONOR.Address Else Case When A.mValue<>B.mValue Then A.mValue+DONOR.ZipCode+B.mValue+DONOR.Address Else A.mValue+DONOR.ZipCode+DONOR.Address End End),Invoice_Address2=(Case When DONOR.Invoice_City='' Then DONOR.Address Else Case When C.mValue<>D.mValue Then C.mValue+DONOR.Invoice_ZipCode+D.mValue+DONOR.Invoice_Address Else C.mValue+DONOR.Invoice_ZipCode+DONOR.Address End End), " & _
                      ...
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
                          ...
                          <tr>
                            ...
                            <td width="14%"><input type="text" name="Donate_Year" size="12" class="font9t" readonly value="<%=RS("Donate_Year")%>"></td>
                          </tr>
                          <%
                            If Cstr(RS("Donate_Payment"))<>Cstr(DonateDesc) Then
                          ...
                          %>
                            ...
                            <td><input type="text" name="Donate_Amt" size="12" class="font9t" readonly value="<%=FormatNumber(RS("Donate_Amt"),0)%>" style="text-align: right"></td>
                            <td align="right">手續費：</td>
                            <td><input type="text" name="Donate_Fee" size="15" class="font9t" readonly value="<%=FormatNumber(RS("Donate_Fee"),0)%>" style="text-align: right"></td>
                            <td align="right">實收金額：</td>
                            <td><input type="text" name="Donate_Accou" size="14" class="font9t" readonly value="<%=FormatNumber(RS("Donate_Accou"),0)%>" style="text-align: right"></td>
                          ...
                          <tr>
                            ...
                            <td colspan="7"><input type="text" name="Invoice_Type" size="12" class="font9t" readonly value="<%=RS("Invoice_Type")%>"></td>
                          </tr>  
                          <tr>
                            <td width="99%" bgcolor="#C0C0C0" height="1" colspan="8"> </td>
                          </tr>
                          ...
                          %>
                            ...
                            <td colspan="4">
                            	<input type="checkbox" name="Same_Owner" value="Y" disabled >同繳費人
                              &nbsp;&nbsp;&nbsp;持卡人身分證：
                          ...
                          %>
                            ...
                            <td colspan="6">
                            	<input type="checkbox" name="Same_Post" value="Y" readonly >同繳費人
                            	&nbsp;&nbsp;&nbsp;存簿局號：
                          ...
                          <tr>
                            ...
                            <td colspan="2"><input type="text" name="Invoice_Title" size="30" class="font9t" readonly value="<%=RS("Invoice_Title")%>"></td>
                          ...
                          <tr>
                            ...
                            <td align="left" colspan="3"><input type="text" name="Act_ShortName" size="46" class="font9t" readonly value="<%=RS("Act_ShortName")%>"></td>
                            <td align="right">活動報名：</td>
                            <td align="left" colspan="3"><input type="text" name="Member_Act_ShortName" size="46" class="font9t" readonly value="<%=RS("Member_Act_ShortName")%>"></td>	
                          </tr>
                          <tr>
                            <td align="right">繳費備註：</td>
                            <td align="left" colspan="3"><textarea rows="3" name="Comment" cols="44" class="font9t" readonly ><%=RS("Comment")%></textarea></td>
                            <td align="right">收據備註：<br />(列印收據用)</td>
                            <td align="left" colspan="3"><textarea rows="3" name="Invoice_PrintComment" cols="41" class="font9t" readonly ><%=RS("Invoice_PrintComment")%></textarea></td>
                          </tr>
                          <tr>
                            <td width="99%" bgcolor="#C0C0C0" height="1" colspan="8"> </td>
                          </tr>
                            ...
                            <td align="center" colspan="8">
                              <%
                                If RS("Issue_Type")<>"D" Then
                                  If Check_Close Then Response.Write"<input type=""button"" value=""修改繳費資料"" name=""Update"" class=""cbutton"" style=""cursor:hand"" onClick=""Update_OnClick()"">&nbsp;&nbsp;"
                                End If
                                ...
                                If Check_Close Then
                                  If RS("Issue_Type")<>"D" Then
                                    ...
                                    Response.Write"<input type=""button"" value=""重新取號"" name=""Return"" class=""cbutton"" style=""cursor:hand"" onClick=""New_InvoiceNo_OnClick()"">&nbsp;&nbsp;"
                                  Else
                              ...
                              %>
				                      ...
				                      <input type="button" value="續增本人繳費資料" name="Add" class="addbutton" style="cursor:hand" onClick="Add_OnClick()">&nbsp;&nbsp;
				                      <input type="button" value="新增他人繳費資料" name="Add" class="delbutton" style="cursor:hand" onClick="Add2_OnClick()">
                            </td>
                          </tr>
                        </table>
                      </td>
...
function Update_OnClick(){
  location.href='member_donate_edit.asp?ctype='+document.form.ctype.value+'&donate_id='+document.form.donate_id.value+'';
}
function Invoice_OnClick(){
  if(confirm('您是否確定要列印收據？')){
    window.open('member_invoice_print_rpt.asp?action=report&invoice_prog='+document.form.Invoice_Prog.value+'&donate_id='+document.form.donate_id.value+'&print_pint='+document.form.Print_Pint.value+'&reprint='+document.form.RePrint.value+'&donatedesc='+document.form.DonateDesc.value+'&Rept_Licence='+document.form.Rept_Licence.value+'','invoice_rpt','toolbar=no,location=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,top=0,left=0,width=800,height=600');
  }
}
...
function New_InvoiceNo_OnClick(){
  location.href='member_donate_new_invoiceno.asp?ctype='+document.form.ctype.value+'&donate_id='+document.form.donate_id.value+'';
}
function Cancel_OnClick(){
  if(document.form.ctype.value=='member_donate_data'){
    location.href='member_donate_data.asp?donor_id='+document.form.Donor_Id.value+'';
  }else{
    location.href='member_donate.asp';
  }
}	
function Add_OnClick(){
  location.href='member_donate_add.asp?ctype=donate_input&donor_id='+document.form.Donor_Id.value+'';
}
