...
<head>
  ...
  <title>繳費單筆收據列印</title>
  <link rel="stylesheet" type="text/css" href="../include/dms.css">
</head>
<body>
<p><div align="center"><center>
    <form name="form" method="post" action="member_invoice_print_rpt.asp" target="main">
              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;">繳費單筆收據列印 </td>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111">
                    ...
                    <tr>
                      ...
                      <td class="td02-c"><input type="text" name="Invoice_No_Begin" size="10" class="font9" onKeypress='if(event.keyCode==13){JavaScript:Report_OnClick();}'> ~ <input type="text" name="Invoice_No_End" size="10" class="font9" onKeypress='if(event.keyCode==13){JavaScript:Report_OnClick();}'><%If Invoice_Pre<>"" Then%>&nbsp;<font color="#ff0000">(&nbsp;機構前置碼不需輸入&nbsp;)</font><%End If%></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="td02-c" align="right" width="100">繳費方式：</td>
                      <td class="td02-c" width="680" colspan="3">
                      <%
                    ...
                    <tr>
                      ...
                      <td class="td02-c" colspan="3">
                        ...
                        <input type="radio" name="OrderBy_Type" id="OrderBy_Type2" value="2">會員編號&nbsp;
...
function Report_OnClick(){
  if(document.form.Donate_Date_Begin.value!=''){
    <%call CheckDateJ("Donate_Date_Begin","繳費日期起")%>
  }
  if(document.form.Donate_Date_End.value!=''){
    <%call CheckDateJ("Donate_Date_End","繳費日期迄")%>
  }
