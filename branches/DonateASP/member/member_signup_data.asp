                      ...
                      <td width="99%">
                        <table border="1" cellpadding="2" style="border-collapse: collapse" width="100%" height="25" cellspacing="1">
                          <tr>
                            ...
                            <%If IsMember="Y" Then%><td class="button2-bg"><img border="0" src="../images/red_arrow.gif" align="texttop">活動報名記錄</td><%End if%>
                    ...
                    <tr>
                      <td class="td02-c" width="100%">
                        <table border="0" cellpadding="1" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          ...
                          <tr>
                            <td class="td02-c" colspan="2" width="100%"><iframe name="detail" src="member_signup_data_list.asp?donor_id=<%=request("donor_id")%>" height="420" width="100%" frameborder="0" scrolling="auto"></iframe></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
