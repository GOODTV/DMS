...
<head>
  ...
  <title>會員地址名條列印</title>
  <link rel="stylesheet" type="text/css" href="../include/dms.css">
</head>
<body>
<p><div align="center"><center>
    <form name="form" method="post" action="member_address_list_rpt.asp" target="report">
              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;">會員地址名條列印</td>
              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111">
                    <tr>
                      <td class="td02-c" align="right">繳費機構：</td>
                    ...
                    <tr>
                      ...
                      <td class="td02-c" align="right">狀態：</td>
                      <td class="td02-c">
                      <%
                    ...
                    <tr>
                      <td class="td02-c" align="right">入會年度：</td>
                      <td class="td02-c">
                      <%
                        SQL1="Select Begin_Year=Isnull(Min(Year(Member_JoinDate)),"&Year(Date())&") From DONOR"
                        Set RS1 = Server.CreateObject("ADODB.RecordSet")
                        RS1.Open SQL1,Conn,1,1
                        If Not RS1.EOF Then Begin_Year=RS1("Begin_Year")
                        RS1.Close
                        Set RS1=Nothing
                        Response.Write "<SELECT Name='Member_JoinYear' size='1' style='font-size: 9pt; font-family: 新細明體'>"
                      ...
                      <td class="td02-c" align="right">組別：</td>
                      <td class="td02-c"><input type="text" name="Member_Group" size="21" class="font9" maxlength="20"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="td02-c" align="right">繳費總金額：</td>
                    ...
                    <tr>
                      ...
                      <td class="td02-c" align="right">繳費總次數：</td>
                    ...
                    <tr>
                      <td class="td02-c" align="right">繳費方式：</td>
                    ...
                    <tr>
                      <td class="td02-c" align="right">繳費用途：</td>
                      <td class="td02-c" colspan="3">
                      <%
                    ...
                    <tr>
                      <td class="td02-c" align="right">繳費類別：</td>
                      <td class="td02-c" colspan="3">
                    ...
                    <tr>
                      ...
                      <td class="td02-c" colspan="3">
                        <!--<input type="radio" name="Print_Type" id="Print_Type1" value="1" checked >郵寄收據&nbsp;<%If InvoiceTypeO<>"" Then%><font color="#ff0000">(&nbsp;限<%=InvoiceTypeO%>列印&nbsp;)</font>&nbsp;<%End If%>-->
                      	...
                      	<input type="radio" name="Print_Type" id="Print_Type6" value="6" >其他
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="td02-c" colspan="3">
                        ...
                        <input type="radio" name="OrderBy_Type" id="OrderBy_Type2" value="2">編號&nbsp;
...
function Report_OnClick(){
  if(document.form.Donate_Date_Begin.value!=''){
    <%call CheckDateJ("Donate_Date_Begin","繳費日期")%>
  }
  if(document.form.Donate_Date_End.value!=''){
    <%call CheckDateJ("Donate_Date_End","繳費日期")%>
  }
