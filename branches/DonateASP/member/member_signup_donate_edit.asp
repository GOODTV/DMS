...
If request("action")="delete" Then
  Check_Close=Get_Close("1",Cstr(request("Dept_Id")),Cstr(request("Donate_Date")),Cstr(Session("user_id")))
  If Check_Close Then
    SQL="Delete From MEMBER_SIGNUP Where ser_no='"&request("Ser_No")&"' " &_
        "Delete From DONATE Where Donate_Id='"&request("Donate_Id")&"' "
...
SQL1="Select * From MEMBER_SIGNUP Where Member_Act_Id='"&request("member_act_id")&"'"
call QuerySQL(SQL1,RS1)
Donate_Id=RS1("Donate_Id")
Member_Signup_Status=RS1("Member_Signup_Status")
Member_Signup_Date=RS1("Member_Signup_Date")
Member_Signup_Price=RS1("Member_Signup_Price")
Member_Signup_Food=RS1("Member_Signup_Food")
Member_Signup_Pay=RS1("Member_Signup_Pay")
RS1.Close
Set RS1=Nothing

If Donate_Id="" Then Response.Redirect "member_signup_edit.asp?member_act_id="&request("member_act_id")&"&ser_no="&request("ser_no")

SQL="Select DONATE.*,Comp_ShortName,Donor_Name=DONOR.Donor_Name,Title=DONOR.Title,Category=DONOR.Category,Donor_Type=DONOR.Donor_Type,InvoiceType=DONOR.Invoice_Type,IDNo=DONOR.IDNo,Member_Type,Last_DonateDate, " & _
                        ...
                        <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          ...
                          <tr>
                            ...
                            <%
                              ...
                              menusize="1"
                              BoundColumn=Member_Signup_Status
                            ...
                            <td colspan="5">
                              <input type="radio" name="Member_Signup_Food" id="Member_Signup_Food1" value="葷" <%If Member_Signup_Food="葷" Then Response.Write "checked" End If%> >葷
                      	      <input type="radio" name="Member_Signup_Food" id="Member_Signup_Food2" value="素" <%If Member_Signup_Food="素" Then Response.Write "checked" End If%> >素
                      	      <input type="radio" name="Member_Signup_Food" id="Member_Signup_Food3" value="不需要" <%If Member_Signup_Food="不需要" Then Response.Write "checked" End If%> >不需要	
                            </td>
                            <%Else%>
                          ...
                          <tr>
                            ...
                            <td width="14%"><input type="text" name="Invoice_Type" size="12" class="font9t" readonly maxlength="10" value="<%=RS("Invoice_Type")%>"></td>
                          </tr>
                          <tr>
