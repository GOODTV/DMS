...
If request("action")="save" Then
  ...
  Else
    session("errnumber")=1
    session("msg")="您輸入的繳費日期『 "&Cstr(request("Donate_Date"))&"』 已關帳無法重新取號 ！"
  End If
End If

SQL="Select DONATE.*,Comp_ShortName,Donor_Name=DONOR.Donor_Name,Title=DONOR.Title,Category=DONOR.Category,Donor_Type=DONOR.Donor_Type,InvoiceType=DONOR.Invoice_Type,IDNo=DONOR.IDNo,Member_Type, " & _
              ...
              <tr>
                ...
                <td width="95%">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;color:#660000;FONT-SIZE: 11pt;letter-spacing: 1;">會員繳費資料重新取號</td>
