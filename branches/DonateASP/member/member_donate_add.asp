...
If request("action")="save" Then
  ...
  If Check_Close Then
    ...
    session("errnumber")=1
    session("msg")="會員繳費資料新增成功 ！"
    If request("ctype")="member_donate_data" Then
      Response.Redirect "member_donate_data.asp?donor_id="&request("donor_id")
    ElseIf request("ctype")="member_edit" Then
      Response.Redirect "member_edit.asp?donor_id="&request("donor_id")  
    Else
      Response.Redirect "member_donate_detail.asp?donate_id="&donate_id&"&ctype="&request("ctype")
    End If
  Else
    session("errnumber")=1
                        ...
                        <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
                          ...
                          <tr>
                            ...
                            <td align="left" colspan="7">
                              ...
                              &nbsp;最近繳費日：
                              <input type="text" name="Last_DonateDate" size="10" class="font9t" readonly value="<%=RS("Last_DonateDateM")%>">	
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td width="14%"><input type="text" name="Donate_Year" size="5" class="font9t" maxlength="4" readonly >(西元)</td>
                          </tr>
                          <tr id="donateamt" style="display:block">
                            <td align="right">繳費金額：</td>
                            <td><input type="text" name="Donate_Amt" size="12" class="font9" maxlength="10" onKeyUp="javascript:SumAccou();" value="<%=request("Donate_Amt")%>"></td>
...
function Cancel_OnClick(){
  ...
  }else  if(document.form.ctype.value=='member_edit'){
    location.href='member_edit.asp?donor_id='+document.form.Donor_Id.value+'';  
  }else{
