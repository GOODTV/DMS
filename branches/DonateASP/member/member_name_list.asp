...
<p><div align="center"><center>
    <form name="form" method="post" action="member_name_qry.asp" target="main">
              ...
              <tr>
                ...
                <td valign="top">
                  <table width="100%" border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111">
                    ...
                    <tr>
                      <td class="td02-c" align="right">讀者姓名：</td>
                      <td class="td02-c"><input type="text" name="Donor_Name" size="19" class="font9"></td>
                      <td class="td02-c" align="right">編號：</td>
                      <td class="td02-c"><input type="text" name="Member_No_Begin" size="9" class="font9"> ~ <input type="text" name="Member_No_End" size="9" class="font9"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="td02-c" colspan="3">
                      	<!--20131002 Modify by GoodTV Tanya-->
